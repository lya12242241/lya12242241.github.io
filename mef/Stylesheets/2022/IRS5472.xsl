		  ...
		  <xsl:variable name="p2DirectCount" select="count($Form5472Data/Direct25PctFrgnShareholderInfo)"/>
			...
			<div style="width:187mm; border-color: black; border-style: solid; border-right-width: 0px; border-left-width: 0px; border-top-width: 1px; border-bottom-width: 0px;">
			  ...
			  <div style="float:right">
				...
				Form <span class="styBoldText" style="font-size: 8pt">5472</span> (Rev. 12-2022)
			  </div>
			</div>
			<!--<div class="pageEnd"/>-->
			<!--END Page 1 FOOTER-->
			...
			<div class="styGenericDiv" style="width:187mm; border-bottom-width:1px solid black;">
			  <div style="float: left; clear: none">Form 5472 (Rev. 12-2022)</div>
			  <div style="float:right">
			...
			<div class="styBB" style="width:187mm;">
			  ...
			  <xsl:choose>
				<xsl:when test="($Print = $Separated)">
					<div class="styNBB" style="width:187mm;padding-bottom:0;">
						<span style="width:43mm;height:11mm;border-right:1px solid black;vertical-align: top;">
							<b> 8b(1) </b> U.S. identifying number,<br/><span style="width:8mm;"/>if any <br/> <span style="width:8mm;"/>
							<xsl:choose>
						...
						<span style="vertical-align: top;width:72mm;min-height:11mm;border-right:1px solid black;">
							<span style="width:1mm;"/><b> 8b(2) </b> Reference ID number (see instructions)<br/><br/>
								<span style="font-size:6.5pt;padding-left:4mm;">
									<xsl:choose>
						...
						<span style="width:72mm;min-height:11mm;">
							<span style="width:1mm;"/><b> 8b(3) </b> FTIN, if any (see instructions)<br/><br/>
								<span style="font-size:6.5pt;padding-left:4mm;">
										<xsl:call-template name="PopulateText">
			...
			<div style="width:187mm; height:4mm;">
			  <div style="float:left;">
				...
				<div class="styLNLeftNumBox" style="width:5mm;">a</div>
				<div class="styLNDesc" style="width:21mm; font-size:6.7pt;">
				  <span style="float:left;">Beginning Balance </span>
				</div>
				<div class="styLNAmountBox" style="width:24mm; height:4mm; border-top-width:0px; border-bottom-width:1px; border-left-width:0px; border-right-width:0px;">
				  <xsl:choose>
					<xsl:when test="$Form5472Data/LoanedBeginningBalAmt !=''">
					  <xsl:call-template name="PopulateAmount">
			...
			<div style="width:187mm; font-size:7pt; page-break-before:always; padding-bottom:0.5mm; bottom-border-width:2px;">
			  <div style="float:left;"> Form 5472 (Rev. 12-2022) </div>
			  <div style="float:right;">
				Page
			...
			<div style="width:187mm; padding-top:1mm;">
			  ...
			  <div style="float:left"> 
				Is the reporting corporation claiming a foreign derived intangible income (FDII) deduction (under section 250) with 
				respect to any transactions 
			  </div>
			</div>
			<div style="width:187mm;padding-bottom:1mm; ">
			  <div class="styLNLeftNumBox" style="padding-left:4mm"/>
			  <div style="float:left">with the foreign corporation?  If "Yes," complete lines 41b, 41c, and 41d. See instructions. </div>
			  <div style="float:right; margin-right:1mm">
				<span class="styDotLn"> .......... </span>
				<div class="styLNDesc" style="clear:none; width: 26mm;">
				  <span>
			...
			<div style="width:187mm; padding-top:1mm">
			  ...
			  <div class="styLNDesc" style="float:left;padding-top:0.5mm;width:179mm;height:6.5mm;"> 
				Enter the amount of gross receipts derived from all sales of general property to the
				foreign related party that the reporting corporation included 					
			  </div>
			</div>
			<div style="width:187mm;">
			  <div class="styLNLeftNumBox" style="padding-left:4mm"/>
			  <div style="float:left">in its computation of foreign-derived 
				deduction eligible income (FDDEI).  See instructions.</div>
			  <div style="float:right; margin-right:1mm">
				<span class="styDotLn"> ........ </span>
				<span class="styLNDesc" style="clear:none; width:33mm;">
				  $
				  <span class="styFixedUnderline" style="width:30mm;text-align:right;float:right;">
					<xsl:call-template name="PopulateAmount">
					  <xsl:with-param name="TargetNode" select="$Form5472Data/AllSlsGeneralPropGrossRcptsAmt"/>
					</xsl:call-template>
				  </span>
				</span>
			  </div>
			...
			<div style="width:187mm; padding-top:1mm;">
			  ...
			  <div style="float:left"> 
				...
				related party that the reporting corporation  
			  </div>
			</div>
			<div style="width:187mm; padding-top:1mm;">
			  <div class="styLNLeftNumBox" style="padding-left:4mm"/>
			  <div style="float:left">included in its computation of FDDEI. See instructions.</div>
			  <div style="float:right; margin-right:1mm">
				<span class="styDotLn"> ................... </span>
				<span class="styLNDesc" style="clear:none; width:33mm;">
				  $
				  <span class="styFixedUnderline" style="width:30mm;text-align:right;float:right;">
					<xsl:call-template name="PopulateAmount">
					  <xsl:with-param name="TargetNode" select="$Form5472Data/AllSlsIntngblPropGrossRcptsAmt"/>
					</xsl:call-template>
				  </span>
				</span>
			  </div>
			...
			<div style="width:187mm; padding-top:1mm;">
			  ...
			  <div style="float:left"> 
				Enter the amount of gross receipts derived from all services provided to the foreign related party 	
			...
			<div style="width:187mm; padding-top:1mm;">
			  ...
			  <div style="float:right; margin-right:1mm">
				...
				<span class="styLNDesc" style="clear:none; width:33mm;">
				  ...
				  <span class="styFixedUnderline" style="width:30mm;text-align:right;float:right;">
					<xsl:call-template name="PopulateAmount">
					  <xsl:with-param name="TargetNode" select="$Form5472Data/ForeignServiceGrossReceiptsAmt"/>
					</xsl:call-template>
				  </span>
				</span>
			  </div>
			...
			<div style="width:187mm; padding-top:1mm;padding-bottom:0;">
			  <div class="styLNLeftNumBox">43a</div>
			  <div style="float:left; padding-top:0.5mm;width:179mm;height:8.5mm;padding-bottom:0;"> 
				Did the reporting corporation make at least one distribution or acquisition (as defined by Regulations 
				section 1.385-3) during the tax year, or, during the period beginning 36 months before the date of the 
				respective acquisition or distribution and ending 36 months afterward, did the 
			  </div>
			</div>
			<div style="width:187mm;padding-bottom:1mm;">
			  <div class="styLNLeftNumBox" style="padding-left:4mm;padding-top:0;"/>
			  <div style="float:left;padding-top:0;">reporting corporation issue or refinance indebtedness owed to a related party?</div>
			  <div style="float:right; margin-right:1mm; padding-top:0mm;">
				<span class="styDotLn">............. </span>
				<div class="styLNDesc" style="clear:none; width: 26mm;padding-top:0;">
				  <span>
					<xsl:call-template name="PopulateSpan">
			...
			<div class="styNBB" style="width:187mm; padding-top:1.5mm;"/>			
			<!-- BEGIN Page 3 Footer -->
<!--			<div style="width:187mm; font-size:7pt;  border-top:1 solid black; padding-top:0.5mm">
			  <div style="float:left; font-size:8pt">
...
<!--			<div style="width:187mm; font-size:7pt;  page-break-before:always; padding-bottom:0.5mm">
		  ...
		  <!-- End repeating group for line 44 - 49b with data -->				
			...
			<xsl:for-each select="$Form5472Data/CostSharingArrangementGrp">
			    ...
			    <div style="width:187mm; padding-top:1mm; border-top:1 solid black; border-top-width: 2px;">
			      ...
			      <div class="styLNDesc" style="clear:none; width:187mm;height:auto;">
			  ...
			  <div style="width:187mm; padding-top:1mm;">
			    ...
			    <div class="styLNDesc" style="width:144mm; float:left;"> 
			      What was the reporting corporation’s share of reasonably anticipated benefits for the CSA?
			    ...
			    <div style="float:right;">				  				
				  <span class="styFixedUnderline" style="width:31mm; text-align:right;">
				    <xsl:call-template name="PopulateAmount">
					  <xsl:with-param name="TargetNode" select="FrgnPartcpShrBnftCSAPct"/>
					</xsl:call-template>
				  </span>
			  ...
			  <div class="styBB" style="width:187mm; height:auto; padding-top:1mm;">
			    <div class="styLNLeftNumBox" style="padding-left:4mm;">b</div>
		  ...
		  <!-- BEGIN Part IX Title -->
			...
			<div class="styTBB" style="width:187mm; padding-top:1mm">
			  ...
			  <div class="styLNDesc" style="width:140mm; float:left;"> 
			    Reserved for future use. 
			  </div>
			  <div style="float:left; ">
				<span style="float:left;">     
				  <input type="checkbox" alt="Part VII Line 4 Qualified Derivative Payment Indicator" 
					  class="styCkbox" disabled="disabled">
				  </input>
				</span>
			  </div>
			</div>
	...
	<xsl:if test="($index &lt;= $max) or ($index &lt;=2)">
	  ...
	  <table class="styIRS5472Table" cellspacing="0" cellpadding="0" border="0">
		...
		<tr style="height:10mm;">
		  <td rowspan="4"> </td>
		  <td rowspan="4" style="padding-left:0.5mm;padding-bottom:1mm;" valign="top">
	  ...
	  <!-- Part II, line 4b(1)-(3) -->
	  <table class="styIRS5472Table" cellspacing="0" cellpadding="0" border="0" style="border-bottom:0;">
		<thead class="styTableThead">
		  <tr style="page-break-inside: avoid !important;">
			<th class="styTableCellHeader"  scope="col" align="left" style="page-break-inside: avoid !important;text-align:left;font-weight:normal;width:50mm; border-right:1px solid black;padding-left:1.5mm;padding-bottom:1mm;" valign="top">
			  <b>
				<xsl:if test="$index &lt; 3">
				  <xsl:value-of select="$index+3"/>
				</xsl:if>b(1)	
			  ...
			  <span style="padding-left:8mm;">if any</span>
			  <br/>
			...
			<th class="styTableCellHeader"  scope="col" align="left" style="text-align:left;font-weight:normal;width:65mm; border-right:1px solid black;padding-left:1mm;padding-bottom:1mm;" valign="top">
			  <b>
				<xsl:if test="$index &lt; 3">
				  <xsl:value-of select="$index+3"/>
			...
			<th class="styTableCellHeader"  scope="col" align="left" style="text-align:left;border-right:0;font-weight:normal;padding-left:1mm;" valign="top">
			  <b>
				<xsl:if test="$index &lt; 3">
				  <xsl:value-of select="$index+3"/>
				</xsl:if>
			  ...
			  <xsl:choose>
				...
				<xsl:when test="$index = 1">
				  ...
				  <br/>
				  <span style="width:7mm;"/> if any (see instructions)
				  <br/>
				</xsl:when>
				<xsl:otherwise>
				  FTIN, if any (see instructions)<br/>
				</xsl:otherwise>
			  </xsl:choose>
			  <span style="font-size:6.5pt;">
				<xsl:if test="($Print != $Separated) or (count($Form5472Data/Direct25PctFrgnShareholderInfo) &lt; 3)">
	  ...
	  <table class="styIRS5472Table" cellspacing="0" cellpadding="0" border="0">
		<thead class="styTableThead">
		  <tr>
			<th class="styTableCellHeader"  scope="col" align="left" style="width:50mm;text-align:left;font-weight:normal;border-bottom:0;border-right:1px solid black;padding-left:1.5mm;" valign="top">
			  <b>
				<xsl:if test="$index &lt; 3">
				  <xsl:value-of select="$index + 3"/>
				</xsl:if>c	
			...
			<th class="styTableCellHeader"  scope="col" align="left" style="width:56mm; text-align:left;font-weight:normal;border-bottom:0;border-right:1px solid black;padding-left:1mm;padding-bottom:1mm;" valign="top">
			  <b>
				<xsl:if test="$index &lt; 3">
				  <xsl:value-of select="$index+3"/>
				</xsl:if>d	
			...
			<th class="styTableCellHeader"  scope="col" align="left" style="width:74mm;text-align:left;font-weight:normal;padding-left:1mm;padding-bottom:1mm;border-right:0;border-bottom:0;" valign="top">
			  <b>
				<xsl:if test="$index &lt; 3">
				  <xsl:value-of select="$index+3"/>
				</xsl:if>e	
			  ...
			  <br/> 
			  <span style="padding-left:4mm;">
				 shareholder files an income tax return as a resident <br/>
			  </span> <br/>
  ...
  <xsl:template name="p2UltimateTemplate">
	...
	<xsl:if test="($index &lt;= $max) or ($index &lt;=2)">
	  ...
	  <table class="styIRS5472Table" cellspacing="0" cellpadding="0" border="0">
		<thead class="styTableThead">
		  <tr>
			<th scope="col" align="left" style="height:auto;font-weight:normal;width:40mm; border-right:1px solid black;padding-left:1.5mm;" valign="top">
			  <b>
				<xsl:if test="$index &lt; 3">
				  <xsl:value-of select="$index + 5"/>
				</xsl:if>b(1)	
			...
			<th scope="col" align="left" style="height:auto;font-weight:normal;width:71mm; border-right:1px solid black;padding-left:1mm;" valign="top">
<!--<div class="styGenericDiv" style="display:block;padding-bottom:1px;">
-->			  <b>
				<xsl:if test="$index &lt; 3">
				  <xsl:value-of select="$index + 5"/>
				</xsl:if>
				<span style="font-size:7pt;height:4mm;">b(2)</span>  
			  </b>						
			  Reference ID number (see instructions)
			  <!--********Font size has to be reduced to 6.5 due to the maxium data size of 50********-->
...
<span style="padding-left:1mm;font-size:6.5pt;height:2mm;"> 
					<xsl:call-template name="PopulateText">
					  <xsl:with-param name="TargetNode" select="ForeignEntityReferenceIdNum"/>
					</xsl:call-template>
