...
<!-- 09/08/2022 - 508 bullet to arrow updates -->
...
Refund Due a Deceased Taxpayer</div>
							<div class="styFST" style="height:5mm;font-size:7pt;padding-top:3mm;"><br/>
								<img src="{$ImagePath}/1310_Bullet.gif" width="9" height="9" alt="right arrow image"/>Go to <i>www.irs.gov/Form 1310</i> for the latest information.
							</div>
							<div class="styFST" style="height:5mm;font-size:7pt;padding-top:0mm;"><br/><br/>
								<img src="{$ImagePath}/1310_Bullet.gif" width="9" height="9" alt="right arrow image"/>See instructions below and on back.
							</div> 
						</div>
					...
					<div style="width:187mm;font-size:8pt;font-weight:bold;">
						...
						<span style="width:150mm;">Signature of person claiming refund  
							<img src="{$ImagePath}/1310_Bullet.gif" width="9" height="9" alt="right arrow image"/></span>
						<span style="width:37mm;">Date  <img src="{$ImagePath}/1310_Bullet.gif" width="9" height="9" alt="right arrow image"/>
							<xsl:call-template name="PopulateMonth">
