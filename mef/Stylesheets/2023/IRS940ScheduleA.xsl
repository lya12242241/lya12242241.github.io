...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<div style="width:187mm;">
		...
		<div class="pageEnd" style="width:187mm;">
			...
			<span style="float:right;clear:none;font-weight:bold;font-size:6pt;padding-top:0.4mm;">Schedule A (Form 940) 2023</span>
		</div>
	...
	<html lang="EN-US">
		<body class="styBodyClass" >
			<div class="styIRS940SATableRow">
				...
				<xsl:choose>
					<xsl:when test="$StateAbrv = 'CA' or $StateAbrv = 'NY' or $StateAbrv = 'VI'">
