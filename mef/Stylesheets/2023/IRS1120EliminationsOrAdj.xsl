				...
				<!-- ******************************************************************************************************* -->		
					...
					<div style="width:187mm;clear:both;">
						<div style="float:left;clear:none;">
							<div class="styLNLeftNumBox">22</div>
							<div class="styLNDesc">
								<span style="float:left;">Elective payment election amount from Form 3800<span/>
								</span>
								<!-- Form to Form Link -->
									<xsl:call-template name="SetFormLinkInline">
...
ApplicableCorpSect59k1CYInd"/>
					...
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="padding-left:4mm;">c</div>
						<div class="styLNDesc" style="width:167mm;">
							<span style="float:left;">Does the corporation meet the requirements of the safe harbor method, if provided under section 59(k)(3)(A), for the current tax</span>
						</div>
						<div class="styGenericDiv">
							<div class="styShadingCell" style="width:6mm;height:4mm;"/>
							<div class="styShadingCellRB" style="width:6mm;height:4mm;border-right-width:0px;"/>
