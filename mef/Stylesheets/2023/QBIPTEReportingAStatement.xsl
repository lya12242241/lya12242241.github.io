      ...
      <xsl:for-each select="$DependencyData/QBIPTEReportingShareTrdBusGrp">
       ...
       <td class="styDepTblCell" style="text-align:left">      		
		...
		<xsl:if test="./PubliclyTradedPartnershipInd">
          ...
          <div style="float:left;clear:none;width:118mm;">
 			<input type="checkbox" class="styckbox" name="checkbox" alt="Publicly Traded Partnership Indicator">
        ...
        <div class="styTopSectionLine" style="width:187mm;">
          ...
          <div style="float:left;clear:none;width:118mm;">
  			<input type="checkbox" class="styckbox" name="checkbox" alt="Aggregated Indicator">
				<xsl:call-template name="PopulateCheckbox">
        ...
        <div class="styTopSectionLine" style="width:187mm;">
          ...
          <div style="float:left;clear:none;width:118mm;">
  			<input type="checkbox" class="styckbox" name="checkbox" alt="S S T B Indicator">
				<xsl:call-template name="PopulateCheckbox">
