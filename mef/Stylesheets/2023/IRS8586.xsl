        ...
        <form id="Form8586">
          ...
          <div class="styTBB" style="width:187mm;">
            <div class="styFNBox" style="width:33mm;height:24mm;">
              ...
              <span class="styAgency">(Rev. December 2023)</span><br/>
        ...
        <div class="styFBT" style="font-size: 8pt; font-weight: normal; margin-top: 0px; ">
         ...
         <!-- <div class="styBB" style="width:187mm;">
          ...
          <div style="width:187mm">
            <div class="styLNLeftNumBoxSD">1</div>
            <div class="styLNDesc" style="width:139mm;">
              <span style="float:left">Number of Forms 8609-A attached </span>
              <!--Dotted Line--> 
				  <div class="styDotLn" style="float:left;padding-right:1mm;">................
					<span style="float:right; margin-right:2mm;">
						<!--<img src="{$ImagePath}/8586_Bullet_L1.gif" alt="Arrow Bullet"/>-->
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:139mm;height:auto;">
              ...
              <span style="width:2mm;"/>  
                If "Yes," enter the building identification numbers (BINs) of the buildings that had a decreased basis. If you
                 need more space, attach a schedule.
                <span style="width:1mm;"/>
              <!--Push Pin Image -->
              <xsl:call-template name="SetFormLinkInline">
          ...
          <div class="styIRS8586TableContainer" id="part1TPctn" style="">
            ...
            <table class="styIRS8586Table" cellpadding="0" cellspacing="0" border="0" style="">
              <xsl:choose>
                <xsl:when test="($Print!=$Separated) or (($Print = $Separated) and 
                (count($Form8586Data/DecrInQlfyBasisOfBldgsAF2007/BIN) &lt;5))">
          ...
          <div style="width:187mm">
              ...
              <div class="styLNRightNumBox" style="width:8mm; height:4mm;">3</div>
              <div class="styLNAmountBox" style="width:28mm; height:4mm;">
                <xsl:call-template name="PopulateAmount">
                  <xsl:with-param name="TargetNode" select="$Form8586Data/CurrentYearCreditAftr2007Amt"/>
                </xsl:call-template>
              </div>
          ...
          <div style="width:187mm">
              ...
              <div class="styLNRightNumBox" style="width:8mm; height:4mm;">4</div>
              <div class="styLNAmountBox" style="width:28mm; height:4mm;">
                <xsl:call-template name="PopulateAmount">
          ...
          <div style="width:187mm">
              ...
              <div class="styLNDesc" style="width:139mm;">
                ...
                Part III, line 4d
                    <!--Dotted Line-->
                    <span style="letter-spacing:4mm;font-weight:bold;float:right;
                      padding-right:1mm;skiplink:display:none;">..</span> 
            </div>
              <div class="styLNRightNumBox" style="height:7.5mm;width:8mm;padding-top:4.5mm;">5</div>
              <div class="styLNAmountBox" style="height:7.5mm;width:28mm;padding-top:4.5mm;">
                <xsl:call-template name="PopulateAmount">
          ...
          <div style="width:187mm">
              ...
              <div class="styLNDesc" style="height:4mm; width:139mm;padding-top:.5mm;">
                Estates and trusts, subtract line 6 from line 5. Report this amount on Form 3800, 
                Part III, line 4d
                <!--Dotted Line-->
                <div class="styDotLn" style="float:right;padding-right:1mm;">...</div>
              </div>
              <div class="styLNRightNumBox" style="height:4mm;width:8mm;padding-top:.5mm;">7</div>
              <div class="styLNAmountBox" style="height:4mm;width:28mm;padding-top:.5mm;">
                <xsl:call-template name="PopulateAmount">
          ...
          <div style="border-style: solid; border-width:1px ; border-left-width:0px;border-right-width:0px; border-bottom-width:0px; font-size:7pt; width:187mm">
            ...
            <div style="float:right">
              ...
              <span style="width:30mm"/>
                Form <b style="font-size:8pt">8586</b> Rev. (12-2023)
            </div>
          </div>
          <div class="pageEnd"/>
