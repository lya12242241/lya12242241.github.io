...
<!-- Last Modified by James Ganzy on 04/13/2023 -->
			...
			<body class="styBodyClass">
				<form id="Form8995AScheduleD">
					...
					<div class="styStdDiv">
						...
						<div class="styFTBox" style="width:127mm;height:22.5mm;">
							...
							<span style="font-weight:bold;">
								<img src="{$ImagePath}/Small_Right_Pointing_Arrow.gif" alt="Small Right Arrow Image"/> Attach to Form 8995-A.
							</span><br />
							<span style="font-weight:bold;">
								<img src="{$ImagePath}/Small_Right_Pointing_Arrow.gif" alt="Small Right Arrow Image"/> Go to
					...
					<div class="styStdDiv" style="border-top:2px solid black;">
						...
						<span style="float:right;font-weight:bold;">Schedule D (Form 8995-A) 2023</span>
					</div>
