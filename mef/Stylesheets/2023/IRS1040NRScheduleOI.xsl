			   ...
			   Name shown on Form 1040-NR<br/>
					...
					<div style="display:inline">
						...
						<div class="styStdDiv" style="margin-bottom:.5mm;">
							...
							<span style="border-bottom:1px dashed black;width:68mm;padding-top:6px;padding-left:.5mm">
						...
						<div class="styStdDiv" style="margin-bottom:.5mm;">
							...
							<div class="sty1040NRScheduleOILongDesc">
								...
								<span style="padding-top:6px">
									<strong>Note: </strong> If you're a resident of Canada or Mexico <b>AND</b> commute to work in the United States at frequent intervals, <br/>
								</span>
								<span style="padding-top:6px">
						...
						<div class="sty1040NRScheduleOITableContainerL" style="width:175mm;margin-left:8mm" id="treatyContainerId">
							...
							<table class="styTable" style="display:table;border-collapse:collapse;font-size:7pt;">
								<thead class="styTableThead">
									<tr>
										<th class="styTableCellHeader" scope="col" style="width:47mm;font-weight:normal;padding-bottom:12px;">
						...
						<div class="styStdDiv" style="margin-bottom:2px;">
							...
							<span class="sty1040NRScheduleOIDotLn" style="padding-right:2px;">..
