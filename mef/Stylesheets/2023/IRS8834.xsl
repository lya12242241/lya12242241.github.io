...
<!-- 06/23/2023 - Changes made for UWR 971529 - Jeremy Nichols -->
<!-- 09/05/2023 - Changes made for UWR 973595 - Jeremy Nichols -->
<!-- 09/25/2023 - Changes made for 2023 pdf review - Jeremy Nichols -->
    ...
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
        ...
        <form name="Form8834">
          ...
          <div class="styBB" style="width:187mm;height: 18mm">
            ...
            <div class="styTYBox" style="width:30mm;height:18mm; border-left-width: 1px">
              ...
              <div class="stySequence"><span style="width:20mm;height:1mm;"/>Attachment<br/>Sequence No. <b>834</b>
              </div>
            </div>
         </div>
          <!--  End title of Form  -->
      ...
      Name(s) shown on return<br/>
          ...
          <div class="styBB" style="width:187mm;font-size:8pt;">
            <b>Notes:</b><BR/>
            <img src="{$ImagePath}/8844_Bullet_Round.gif" title="bullet" alt="bullet"/> Use this form to claim qualified electric vehicle passive activity credits from prior
             years (allowed on <br/>Form 8582-CR or Form 8810 for the current year).  The qualified electric vehicle 
			credit was available for certain vehicles placed in service before 2007.<br/>
			<img src="{$ImagePath}/8844_Bullet_Round.gif" title="bullet" alt="bullet"/> Claim the credit for certain clean vehicles placed in service after 2022 on Form 8936.</div>
       ...
       <img src="{$ImagePath}/8844_Bullet_Round.gif" title="bullet" alt="bullet"/>    Individuals. Enter the sum of the amounts from Form 1040, 1040-SR, or 1040-NR, line 16, and Schedule 2 (Form 1040), line 2.<br/>
        <img src="{$ImagePath}/8844_Bullet_Round.gif" title="bullet" alt="bullet"/>    Corporations. Enter the amount from Form 1120, Schedule J, line 1; or the
...
lines 1a and 1b, or the amount from the applicable line of your return.                   
      ...
      <div style="width:187mm;">
        ...
        <li style="height: 6.5mm; padding-top: .75mm" title="bullet" alt="bullet">Corporations. Applicable corporations (see Form 4626), enter the amount from Form 4626, Part II, line 9. Other corporations, enter -0-.</li>
...
<span style="letter-spacing:4mm; font-weight:bold"> .........
  ...
  <div class="styLNRightNumBoxNBB" style="width:8.4mm;height:4.5mm;border-right-width:1px;padding-top:0mm;background-color:lightgrey;"/>
     ...
     <div style="width:187mm; border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width: 0px">
            ...
            <div class="styGenericDiv" style="float:right;">Form <span class="styBoldText">8834</span> (Rev. 12-2023)</div>
          </div><br/><br/>
