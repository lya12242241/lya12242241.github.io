...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
   ...
   The organization is not a private foundation because it is: (For lines 1 through 12, check only one box.)
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" 
						 alt="IRS990SchAMedicalResearchOrganizationInd">
							<xsl:call-template name="PopulateCheckbox">
						...
						<xsl:for-each select="$FormData/AgriculturalNameAndAddressGrp">
							...
							<xsl:if test="CollegeUniversityName/BusinessNameLine2Txt !=''">
								<div style="font-family:verdana;font-size:7pt;padding-left:16mm;">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" 
										 select="CollegeUniversityName/BusinessNameLine2Txt"/>
									</xsl:call-template>,           
								</div>
							</xsl:if>
							<br/>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" 
						 alt="IRS990SchASupportingOrganization509a3Ind">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescIV">
					  ...
					  <b>section 509(a)(1)</b> or <b>section 509(a)(2).</b> See 
					  <span 
					   style="font-weight:bold;">section 509(a)(3).
					  </span> Check the box on lines 12a through 12d that describes the type of supporting 
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIV">
						...
						elect a majority of the directors or trustees of the supporting organization. <b>You must complete 
						Part IV, Sections A and B.</b>
					</div>
				</div>
				<!-- line 12b -->
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIV">
						<b> Type II.</b> A supporting organization supervised or controlled in connection with its supported 
						organization(s), by having control or management of the supporting organization vested in the same
						persons that control or manage the supported organization(s).<b> You must complete Part IV, Sections 
						A and C.</b>
					</div>
				</div>
				<!-- line 12c -->
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIV">
						<b>Type III non-functionally integrated.</b> A supporting organization operated in connection with 
						its supported organization(s) that is not functionally integrated. The organization generally must 
						satisfy a distribution requirement and an attentiveness requirement (see instructions). <b>You must 
						complete Part IV, Sections A and D, and Part V.</b>
					</div>
				</div>
				<!-- line 12e -->
				<div class="IRS990ScheduleA_LineContainer">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIV" style="width:180mm;">
						...
						<span class="styFixedUnderline" style="width:30mm;float:none;padding-left:2mm;padding-top:0;
...
-->
    ...
    <xsl:with-param name="containerID" select="'p1Ln11TbCtnr'"/>
				...
				<div style="width:187mm; border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 1px; border-bottom-width: 0px">
					...
					<div style="width:57mm;text-align:right;float:right;font-size:7pt;font-weight:bold;">Schedule A (Form 990) 2023</div>
				</div>
				<div class="pageEnd"/>
				<p style="page-break-before: always"/>
				<!-- Page Header -->
				<div class="styBB" style="width:187mm; padding-bottom:.5mm;">
					<div style="float:left;">Schedule A (Form 990) 2023</div>
						...
						<tr>
							...
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							 vertical-align:center;" 
								scope="col">(a) <span class="styNormalText"> 2019</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							 vertical-align:center;" 
								scope="col">(b) <span class="styNormalText"> 2020</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							 vertical-align:center;" 
								scope="col">(c) <span class="styNormalText"> 2021</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							 vertical-align:center;" 
								scope="col">(d) <span class="styNormalText"> 2022</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							 vertical-align:center;" 
								scope="col">(e) <span class="styNormalText"> 2023</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;border-right-width:0px;
							 text_align:center;vertical-align:center;" 
						...
						<tr>
							...
							<td class="IRS990ScheduleA_MoneyCell" style="border-right-width:0px;width:25mm;
							 font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/GiftsGrantsContriRcvd170Grp/TotalAmt"/>
								</xsl:call-template>
							</td>
						</tr>
						<tr>
					...
					<div class="IRS990ScheduleA_LineDescIVA">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  Public support percentage for 2023 (line 6, column (f) divided by line 11, column (f))
							   <span class="IRS990ScheduleA_DotSpacing">.........  </span>
						</label>
					</div>
					...
					<div class="IRS990ScheduleA_LineDescIVA">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  Public support percentage for 2022 Schedule A, Part II, line 14
							   <span class="IRS990ScheduleA_DotSpacing">...............  </span>
						</label>
					</div>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIVB" style="height:auto;">
						<span style="font-weight:bold;">
						    33 <span style="font-size:5pt;">1/3</span>% support test—2023.
						</span>
							...
							<span style="font-size:5pt;">1/3</span>% or more, check this box<br/> and <b>stop here.</b>  The
							 organization qualifies as a publicly supported organization
							  <span class="IRS990ScheduleA_DotSpacing">.......................</span>
							  <img src="{$ImagePath}/990SchA_Bullet_Line.gif" alt="right arrow"/>
						<input class="IRS990ScheduleA_Checkbox" 
								type="checkbox" alt="IRS990SchAThirtyThrPctSuprtTestsCY170Ind">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIVB" style="height:auto;">
						...
						<span class="IRS990ScheduleA_DotSpacing">.....................  </span>
							<img src="{$ImagePath}/990SchA_Bullet_Line.gif" alt="right arrow"/>
						<input class="IRS990ScheduleA_Checkbox" 
								type="checkbox" alt="IRS990SchAThirtyThrPctSuprtTestsPY170Ind">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIVB" style="height:auto;">
							...
							<img src="{$ImagePath}/990SchA_Bullet_Line.gif" alt="right arrow"/>
						<input class="IRS990ScheduleA_Checkbox" 
								type="checkbox" alt="IRS990SchATenPctFactsCrcmstncsTestCYInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIVB" style="height:auto;">
							...
							<img src="{$ImagePath}/990SchA_Bullet_Line.gif" alt="right arrow"/>
							<input class="IRS990ScheduleA_Checkbox" 
									type="checkbox" alt="IRS990SchATenPctFactsCrcmstncsTestPYInd">
								<xsl:call-template name="PopulateCheckbox">
				...
				<div class="pageEnd" style="width:187mm;border-top-width:1px;">
					<div style="float:right;">
						...
						<span class="styBoldText"> Schedule A (Form 990) 2023</span>
					</div>
				</div>
				<!-- END Footer -->
				<p style="page-break-before: always"/>
				...
				<div class="IRS990ScheduleA_TableContainer" style="border-bottom-width:0px;">
					<table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						<tr>
							...
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							  vertical-align:center;" scope="col">(a) <span class="styNormalText"> 2019</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							  vertical-align:center;" scope="col">(b) <span class="styNormalText"> 2020</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							  vertical-align:center;" scope="col">(c) <span class="styNormalText"> 2021</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							  vertical-align:center;" scope="col">(d) <span class="styNormalText"> 2022</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							  vertical-align:center;" scope="col">(e) <span class="styNormalText"> 2023</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;border-right-width:0px;
				...
				<div class="IRS990ScheduleA_TableContainer" style="border-bottom-width:0px;">
					<table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						<tr>
							<th class="IRS990ScheduleA_GenericCell" 
								style="width:60mm;font-weight:bold;border-bottom-width:0px;" scope="col" colspan="2">
								<span style="float: left; clear: both"> Calendar year 
							...
							<th class="IRS990ScheduleA_GenericCell" 
								style="width:25mm;text_align:center;vertical-align:center;" scope="col">(a) 
									<span class="styNormalText"> 2019</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" 
								style="width:25mm;text_align:center;vertical-align:center;" scope="col">(b) 
									<span class="styNormalText"> 2020</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" 
								style="width:25mm;text_align:center;vertical-align:center;" scope="col">(c) 
									<span class="styNormalText"> 2021</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" 
								style="width:25mm;text_align:center;vertical-align:center;" scope="col">(d) 
									<span class="styNormalText"> 2022</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" 
								style="width:25mm;text_align:center;vertical-align:center;" scope="col">(e) 
									<span class="styNormalText"> 2023</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" 
								style="width:25mm;border-right-width:0px;text_align:center;vertical-align:center;"
								scope="col">(f) <span class="styNormalText"> Total</span>
							</th>
						</tr>
						<tr>
            ...
            <xsl:with-param name="TargetNode" select="$FormData/OtherIncome"/>
					...
					<div class="IRS990ScheduleA_LineDescIVA">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  Public support percentage from 2022 Schedule A, Part III, line 15
							   <span class="IRS990ScheduleA_DotSpacing">...............  </span>
						</label>
					</div>
					...
					<div class="IRS990ScheduleA_LineDescIVA">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  Investment income percentage for <b>2023</b> (line 10c, column (f) divided by line 13, 
							  column (f))
							   <span class="IRS990ScheduleA_DotSpacing">......  </span>
						</label>
					</div>
					...
					<div class="IRS990ScheduleA_LineDescIVA">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  Investment income percentage from <b>2022</b> Schedule A, Part III, line 17
							   <span class="IRS990ScheduleA_DotSpacing">.............  </span>
						</label>
					</div>
				...
				<div class="IRS990ScheduleA_LineContainer" style="padding-left:0.8mm;">
					...
					<div class="IRS990ScheduleA_LineDescIVB" style="height:auto;">
						...
						<img src="{$ImagePath}/990SchA_Bullet_Line.gif" alt="right arrow"/>
						<input class="IRS990ScheduleA_Checkbox" 
								type="checkbox" alt="IRS990SchAThirtyThrPctSuprtTestsCY509Ind">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="styBB" style="width:187mm;float:none;">
					...
					<tr>
						<div class="IRS990ScheduleA_LineContainer">
							...
							<div class="IRS990ScheduleA_LineIndex">
								<input class="IRS990ScheduleA_Checkbox" type="checkbox" 
								 alt="IRS990SchATrustIntegralPartTestInd">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/TrustIntegralPartTestInd"/>
							...
							<div class="IRS990ScheduleA_LineDescIV">
										...
										on Nov. 20, 1970 <i>(explain in <b>Part VI</b>)</i>. <b>See instructions.</b> All 
				...
				<table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
					<tr>
						...
						<td class="styLNDesc" style="width:107mm;height:4.5mm;" colspan="3">
							<span class="styBoldText" style="font-size:8pt;font-weight:bold; padding-top:1mm;"> Section A - 
							 Adjusted Net Income
							</span>
						</td>
...
line 8, Column A)
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								<span class="styBoldText" style="padding-left: 1.5mm">2</span>
								<span style="width: 1mm"/>
									 Underdistributions, if any, for years prior to 2023 <span style="padding-left: 7mm"/>
									 <span style="width:5mm;">
       ...
       Applied to underdistributions of prior years
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1.5mm;"/>
									Carryover from 2018 not applied (see <br/>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1mm"/>Distributions for 2023 from Section D, line 7:</td>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 5mm"/> 2023, if any. Subtract lines 3g and 4a from line 2.<br/>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1mm"/>
									Remaining underdistributions for 2023. Subtract <br/>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1mm"/>
								<b> Excess distributions carryover to 2024.</b> Add lines <br/>
				...
				<div style="width:187mm">
					<div style="float:right">
						<span class="styBoldText" style="font-size: 7pt">Schedule A (Form 990)</span> (2023)
					</div>
				</div>
				<div class="pageEnd"/>
				<!--END FOOTER-->
    ...
    Page <span class="styBoldText" style="font-size: 8pt">7</span>
				...
				<div class="styBB" style="width:187mm;float:none;border-top-width:1px">
					...
					<span style="font-size:7pt;padding-left:2mm;width: 170mm;">
				     <b>Supplemental Information.</b> Provide the explanations required by Part II, line 10; Part II, line
				      ...
				      for any additional information. (See instructions).</span>
				</div>
				...
				<!--<div class="styBB" style="width:187mm;padding-top:1mm;padding-bottom:1mm;clear:both; 
				border-top:1 solid black;height:auto">-->
              ...
              <xsl:with-param name="containerID" select="'SUPctn'"/>
				...
				<p style="page-break-before: always"/>
				<br/>
				<div class="styTableContainer" style="width:187mm;clear:all;height:auto;display:block;" id="SUPctn">
