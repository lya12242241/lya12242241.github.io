			   ...
			   Name shown on Form 1040-NR<br/>
					...
					<div class="styStdDiv" style="border-top:1px solid black;">
						...
						<div style="width:167mm;float:left;">
							...
							<div class="styLNRightNumBox" style="border-bottom:none;height:5mm;padding-top:1mm;">1b</div>
							<div class="styLNAmountBox" style="border-bottom:none;
							    height:5mm;padding-top:.5mm;">
								<xsl:call-template name="PopulateAmount">
					...
					<div class="styStdDiv" style="border-top:1px solid black;">
						...
						<div style="width:167mm;float:left;">
							...
							<div class="sty1040NRScheduleAIndentDesc" style="height:26mm;">
								...
								<span style="border-bottom:1px dashed black;width:47.5mm;"> </span>
								<br/>
