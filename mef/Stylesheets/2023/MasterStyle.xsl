        ...
        <style type="text/css">
          ...
          <xsl:for-each select="/AppData/PrintDocuments/Document">
            <xsl:choose>
              ...
              <xsl:when test="@documentName='IRS1099B'">
                <xsl:call-template name="IRS1099BStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS1099DIV'">
                <xsl:call-template name="IRS1099DIVStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS1099G'">
                <xsl:call-template name="IRS1099GStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS1099INT'">
                <xsl:call-template name="IRS1099INTStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS1099K'">
                <xsl:call-template name="IRS1099KStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS1099MISC'">
                <xsl:call-template name="IRS1099MISCStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS1099NEC'">
                <xsl:call-template name="IRS1099NECStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS1099OID'">
                <xsl:call-template name="IRS1099OIDStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS1099PATR'">
