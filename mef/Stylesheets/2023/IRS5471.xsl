				...
				<form name="IRS5471">
					...
					<div class="styBB" style="width:187mm;">										
						<div class="styFNBox" style="width:28.25mm; height: 23mm; border-bottom-width:1pt; border-right-width:1pt;">
							...
							<div class="styAgency">(Rev. December 2023)</div>
							...
							<table class="styTable" cellspacing="0" style="width:187mm;font-size:7pt;">
								...
								<tr>
									<td class="styTableCell" valign="top" style="width: 59.5mm;height: 9.5mm;border-color:black;border-right-width: 0px;font-size:7pt;">
										<span style="width:64mm;text-align:left;padding-left:1mm;padding-bottom:5mm;">
											<b>b(3)</b>
											<span style="padding-left:1mm;font-size:7pt">Previous reference ID number(s), if any  
                                         </span>
										</span>
										<br/>
										<br/>
											...
											<xsl:choose>
												...
												<xsl:otherwise>
													<xsl:for-each select="$IRS5471Data/ForeignEntityIdentificationGrp">
														<tr>
															<td class="styTableCell" style="vertical-align:bottom;height:14mm;border-color:black;border-right:0;border-left:1px solid black;width: 73mm;">
		...
		<!--  ************************************************************************************************************************************************************************  -->	
			<!--<span class="styTableCell" style="text-align:left;padding-left:2mm;height:9.5mm;border:none;border-left:1px solid black;width:76mm;">	-->	
					...
					<div style="width:187mm; border-color: black; border-style: solid; border-right-width: 0px;
					 border-left-width: 0px; border-top-width: 1px; border-bottom-width: 0px;">
						...
						<div style="float:right">
							...
							Form <span class="styBoldText" style="font-size: 8pt">5471</span> (Rev. 12-2023)
						</div>
					</div>
					<!--<div class="pageEnd"/>-->
					<!--END FOOTER-->
					...
					<div class="styGenericDiv" style="width:187mm">
						<div style="float: left; clear: none">Form 5471 (Rev. 12-2023)</div>
						<div style="float:right">
...
<!--														<td class="styIRS5471TableLastCol" id="FSspcr" style=""/>-->
      ...
      forward to the current
					...
					<div class="styGenericDiv" style="width:187mm">
						...
						<span class="styLNDesc" style="width:155mm; height: 6mm;">
					...
					<div class="styGenericDiv" style="width:187mm">
						...
						<span>
							...
							<input type="checkbox" alt="Safe Haven Rate Rules of Regulations Applicable Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/SafeHavenRtRegsRtIntAFRInd"/>
						...
						<span>
							...
							<input type="checkbox" alt="Safe Haven Rate Rules of Regulations Applicable No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/SafeHavenRtRegsRtIntAFRInd"/>
					...
					<div class="styGenericDiv" style="width:187mm;height:10mm;">
						<span class="styLNLeftNumBox">18b</span>
						<span class="styLNDesc" style="width:155mm;height:7mm;">
 Did the filer have any loan to or from the foreign corporation to which the safe-haven rate rules of Regulations section 1.482-2(a)(2)(iii)(B) are applicable, and for which the filer used a rate of interest within the relevant safe-haven range (100 to 130% of the applicable Federal rate (AFR) for the relevant term)? 
						</span>
					<div class="styGenericDiv" style="width:187mm">
						<span class="styLNDesc" style="width:162mm; margin-left:8mm;">
					...
					<span class="styLNLeftNumBox" style="padding-left:3mm;">(1)</span>
						<span class="styLNDesc" style="width:162mm; ">
							...
							<span style="width:1mm"/>$
							<span class="sty1120FItemUnderlineSM" style="width:12mm;">
								<xsl:call-template name="PopulateAmount">
