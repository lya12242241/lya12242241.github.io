...
<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
 ...
 <body class="styBodyClass" style="width:187mm">
      ...
      <div class="styFMT" style="line-height:100%;height:14mm;font-size: 12pt; font-weight: bold; padding-top: 2mm">
        <div class="styMainTitle">Consent of Shareholder To Include<br/>Specific Amount in Gross Income<br/></div>
          ...
          <span style="font-size:7pt;height:9mm;">(Send this form to the corporation claiming the deduction for consent dividends.)
			<br/>
			<!--<img src="{$ImagePath}/972_Bullet_Md.gif" alt="medium right arrow"/>-->&#160; Information about Form 972 and its instructions is at 
  ...
  <div style="width:187mm;float:none;clear:none;" class="styBB">        
    ...
    <div style="float:left;">Enter the last day of the corporation’s tax year <!--<img src="{$ImagePath}/972_Bullet_Md.gif" alt="medium right arrow"/>--> 
...
<!--Line 3 table-->
    ...
    <tbody style="border-color:black; vertical-align:bottom;">
      ...
      <tr>
        ...
        <span class="styBoldText">4</span><span style="padding-left:4mm">Total consent distribution</span>
          ...
          <!--<img src="{$ImagePath}/972_Bullet_Md.gif"  style="padding-left:3mm;" alt="medium right arrow"/>--> 
        </td>        
  ...
  <br/>
  <div><span class="styBoldText" style="padding-top:1mm;padding-right:1mm;">Consenting shareholder </span> <!--<img src="{$ImagePath}/972_Bullet_Sm.gif" alt="medium right arrow"/>--> <span class="styUnderlineAmount" style="float:none;font-weigt:bold;width:151mm"/></div>
<div>
  <span class="styBoldText" style="padding-right:1mm;">Title </span> <!--<img src="{$ImagePath}/972_Bullet_Sm.gif" alt="medium right arrow"/>-->  <span style="padding-left:140mm;padding-bottom:1mm;padding-top:1mm;"><span class="styBoldText">Date </span> <!--<img src="{$ImagePath}/972_Bullet_Sm.gif" style="padding-left:1mm;" alt="medium right arrow"/>--></span></div>
</div>
