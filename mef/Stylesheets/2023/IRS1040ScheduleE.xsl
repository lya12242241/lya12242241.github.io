				...
				<form id="IRS1040ScheduleE">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px;">
						...
						<div class="styTableContainer" style="width:188mm;border-bottom-width:1px;height:auto;" id="PICctn">
							<!--<xsl:call-template name="SetInitialState"/> ss 2023.06.25 -->
											...
											<tr style="height:auto;">
												...
												<td class="styTableCell" style="width:63.6mm;text-align:left;border-bottom-width:0px;">
													...
													<xsl:call-template name="LinkToLeftoverDataTableInline">
														<xsl:with-param name="Desc">Part I, Line 21 Net Rental Income Or Loss Amt: Form 6198 </xsl:with-param>
														<xsl:with-param name="TargetNode" select="$FormData/PropertyRealEstAndRoyaltyGroup/NetRentalIncomeOrLossAmt/@form6198Cd"/>
													</xsl:call-template>
													<span class="styDotLn" style="padding-right:1mm;float:right;clear:none;">.</span>
												</td>
												<!-- Column 3 -->
					...
					<div class="pageEnd" style="width:187mm;page-break-after:always;display:block;">
                        ...
                        <span class="styBoldText" style="font-size:7pt;padding-top:.0mm;padding-left:5mm;float:right;">Schedule E (Form 1040) 2023</span>
                    </div>
					<p class="pageEnd" style="page-break-after:always;display:block;"/>
					<!-- end page 1 footer -->
					<!-- Page 2 -->
					<div class="styTBB" style="height:5.5mm;width:187mm;">
						<span style="float:left;clear:none;padding-top:1mm;">Schedule E (Form 1040) 2023</span>
					...
					<div style="width:187mm;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;font-weight:normal;height:auto;">
							<span class="styBoldText">Income or Loss From Partnerships and S Corporations</span> 
							<br/><b>Note:</b> If you report a loss, receive a distribution, dispose of stock, or receive a loan repayment from an S corporation, you <b>must</b> check the box in column 
                  ...
                  Income or Loss From Real Estate Mortgage Investment Conduits (REMICs)-Residual Holder 
						...
						<div style="width:187mm;">
                           ...
                           1065), box 14, code B; Schedule K-1 (Form 1120-S), box 17, code AN; and
                           Schedule
						...
						<div class="pageEnd" style="height:6mm;width:187mm;">
							...
							<div class="stySmallText" style="width:66mm;text-align:right;">
								<span class="styBoldText" style="font-weight:bold;font-size:7pt">Schedule E (Form 1040) 2023</span>
							</div>
						</div>
					</div>
					<!-- end page 2 footer -->
						...
						<tr>
							...
							<td class="styLeftOverTableRowAmount" style="width:100mm;" scope="row">
								<xsl:call-template name="PopulateLeftoverRow">
									<xsl:with-param name="Desc">Part I, Line - 21 - Net Rental Income Or Loss Amt: Form 6198 </xsl:with-param>
									<xsl:with-param name="TargetNode" select="$FormData/PropertyRealEstAndRoyaltyGroup/NetRentalIncomeOrLossAmt/@form6198Cd"/>
									<xsl:with-param name="BackupName">$FormData/PropertyRealEstAndRoyaltyGroup/NetRentalIncomeOrLossAmt/@form6198Cd</xsl:with-param>
								</xsl:call-template>
							</td>						
