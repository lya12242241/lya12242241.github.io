...
<!-- 11/28/2023 - Changes for 1319513 - AJH -->
...
<xsl:call-template name="LinkToLeftoverDataTableInline">
          ...
          <div class="IRS1120POL_FormYearBlock">
            ...
            <div class="IRS1120POL_TaxYear">
							<span>20<span class="styTYColor">23</span>
							</span>
            </div>
          </div>
        </div>
        ...
        <div class="IRS1120POL_LineContainer">
          <div class="IRS1120POL_LabelSpace" style="border-right-width:1px;height:8mm"/>
          <div class="IRS1120POL_LineIndex"/>
          <div class="IRS1120POL_LineDescLong" style="width:15mm;border-right-width:0px;"/>
          <div class="IRS1120POL_LineDescLong" style="width:4mm;border-right-width:0px;font-weight:bold;height:8mm">d</div>
          <div class="IRS1120POL_LineDescLong" style="width:87mm;border-right-width:1px;height:8mm">
            ...
            <!--Dotted Line-->
            <span style="letter-spacing:4mm; font-weight:bold;border-right-width:1px">............</span>
                 <!--span class="IRS1120POL_DotSpacing">.....</span-->
          </div>
          <div class="IRS1120POL_LineIndexMid" style="height:8mm;padding-top:4mm">23d</div>
          <div class="IRS1120POL_MoneyFieldMid" style="height:8mm;padding-top:4mm">
            <xsl:call-template name="PopulateAmount">
             <xsl:with-param name="TargetNode" select="$FormData/ElectivePaymentAmt"/>
            </xsl:call-template>
          </div>
     ...
     <!--<div class="IRS1120POL_LineContainer">
       ...
       <!-- </div>-->
        ...
        <div class="IRS1120POL_LineContainer">
          ...
          <div class="IRS1120POL_LineIndex"/>
          <div class="IRS1120POL_LineDescLong" style="width:15mm;border-right-width:0px;"/>
          <div class="IRS1120POL_LineDescLong" style="width:4mm;border-right-width:0px;font-weight:bold;">e</div>
        ...
        <!-- additional info line 1 -->
			...
			<div class="IRS1120POL_LineContainer" >
              ...
              At any time during the 2023 calendar year, did the organization have an interest in or a signature or other 
              </div>
 </div>
...
<!-- END Signature Section -->
        ...
        <div class="IRS1120POL_LineContainer">
          ...
          <div style="width:37mm;text-align:right;float:left;">Form <span style="font-weight:bold;">1120-POL </span> (2023)</div>
        </div>
        <!-- leftover data table -->
