...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
				...
				<form name="IRS8606" style="font-family:arial;">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:2px;">
						...
						<div class="styTYBox" style="width:30mm;border-left-width:2px;height:23mm;">
							...
							<div class="styTY">20<span class="styTYColor">23</span>
							</div>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styNameBox" style="width:137mm;height:8mm;font-weight:normal;font-size:7pt;">
							Name. If married, file a separate form for each spouse required to file 2023 Form 8606. See instructions.<br/>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styIRS8606LineItem" style="height:27mm;">
							...
							<div class="styIRS8606LineItem" style="width:25%;float:left;height:27.2mm;">
								<!-- Text -->
								<div class="styIRS8606LineItem" style="width:83%;float:left;font-size:8pt;padding:6.3mm 0px 7px 0px;height:27.2mm;">
							...
							<div class="styIRS8606LineItem" style="width:75%;float:left;height:27.2mm;">
								<div class="styIRS8606LineItem" style="width:100%;border-bottom-width:1px;border-color:black;height:30%;">
									<div class="styIRS8606LineItem" style="width:118mm;height:100%;float:left;padding-left:4px">
                                        ...
                                        <xsl:choose>
										      <xsl:when test="($RtnHdrData/ReturnTypeCd='1040') or ($RtnHdrData/ReturnTypeCd='1040NR') ">
											  </xsl:when>
											  <xsl:otherwise>
											   	<br/>
					...
					<div style="width:187mm;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;padding-bottom:3px;height:auto;">
							Nondeductible Contributions to Traditional IRAs and Distributions From Traditional, Traditional SEP, and Traditional SIMPLE IRAs<br/></div>							
							<div class="styPartDesc" style="width:187mm;height:auto;">
	...
	<table class="styNormalText" style="font-size:7pt; vertical-align:top;">
		<tbody>
			<tr>
				<td style="vertical-align:top;"><img src="{$ImagePath}/8606_Bullet_Round.gif" alt="RoundBullet"/></td>
				<td style="vertical-align:top;">You made nondeductible contributions to a traditional IRA for 2023.</td>
			</tr>
			<tr>
				<td style="vertical-align:top;"><img src="{$ImagePath}/8606_Bullet_Round.gif" alt="RoundBullet"/></td>
				<td style="vertical-align:top;">You took distributions from a traditional, traditional SEP, or traditional SIMPLE IRA in 2023 <b>and</b> you made nondeductible contributions to a 
			        traditional IRA in 2023 or an earlier year. For this purpose, a distribution does not include a rollover (other than certain qualified disaster distribution repayments 
			        from 2023 Form(s) 8915-F ), qualified charitable distribution,  one-time  distribution to fund an HSA, conversion, recharacterization, or return of certain contributions. 
				</td>
			</tr>
				<tr>
				<td style="vertical-align:top;" ><img src="{$ImagePath}/8606_Bullet_Round.gif" alt="RoundBullet"/></td>
				<td style="vertical-align:top;" >You converted part, but not all, of your traditional, traditional SEP, and traditional SIMPLE IRAs to Roth, Roth SEP, or Roth SIMPLE IRAs in 2023  
	             <b>and</b> you made nondeductible contributions to a traditional IRA in 2023 or an earlier year.
				</td>
			</tr>
		</tbody>
	</table>	
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styIRS8606LineItem" style="height:auto;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;">
									Enter your nondeductible contributions to traditional IRAs for 2023, including those made for 2023 from January 1, 2024,
									<span style="float:left;">through April 15, 2024. See instructions</span>
									<!--Dotted Line-->
						...
						<div class="styIRS8606LineItem" style="height:auto;">
							<div class="styIRS8606LNDesc" style="padding:0px 0px 0px 0px;width:9mm;height:16mm;"/>
							<div class="styIRS8606LNDesc" style="padding:0px 0px 0px 0px;width:55mm;height:16mm;border-width:2px 2px 2px 2px;border-color:black;">
								<span class="styBoldText" style="width:100%;height:100%;padding-left:4mm;padding-top:1.5mm;">
									In 2023, did you take a distribution from<br/>
									 traditional, traditional SEP, or traditional SIMPLE IRAs,
									or make a Roth, Roth SEP, <br/>or Roth SIMPLE IRA conversion?
								</span>
							</div>
							<div class="styIRS8606LNDesc" style="padding:0px 0px 0px 0px;width:86mm;height:16mm;">
						...
						<div class="styIRS8606LineItem"  style="height:10mm;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding-left:3mm;">
								Enter the value of <b>all</b> your traditional, traditional SEP, and traditional SIMPLE IRAs as of December 31, 2023, 
								plus any outstanding rollovers. Subtract certain repayments of qualified disaster distributions, if any, from 2023 Form(s) 8915-F (see instructions)
								<span class="styDotLn" style="float:right;padding-right:1mm;">...............................</span>
							...
							<xsl:call-template name="CreateBox">
								...
								<xsl:with-param name="AmountBoxStyle">border-width:0px 0px 1px 1px; padding-top:6mm</xsl:with-param>
								<xsl:with-param name="NumberBoxStyle">border-width:0px 0px 1px 1px; padding-top:6mm</xsl:with-param>								
							</xsl:call-template>
						</div>
						<!-- (7) ////////////////////////////////////////////////////-->
						<div class="styIRS8606LineItem" style="padding-bottom:0mm; height:14mm;">
							<div class="styIRS8606LNLeftNumBox">7</div>
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;font-size:7pt;">
									<span style="float:left;">
									Enter your distributions from traditional, traditional SEP, and traditional SIMPLE IRAs in 2023.
									<b>Do not</b> include rollovers (other than repayments of qualified disaster distributions, if any, from 2023 Form(s) 8915-F (see instructions)); qualified charitable distributions; a one-time
									 distribution to fund an HSA; conversions to a Roth, Roth SEP, or Roth SIMPLE IRA; certain returned contributions; or recharacterizations of traditional IRA contributions (see instructions) 
                                        <span class="styDotLn" style="float:right;padding-right:1mm;">............</span>
                                        </span>
				<!--					<span style="float:left;">instructions)</span>-->
							...
							<xsl:call-template name="CreateBox">
								...
								<xsl:with-param name="AmountBoxStyle">border-width:0px 0px 1px 1px; padding-top:9.5mm</xsl:with-param>
								<xsl:with-param name="NumberBoxStyle">border-width:0px 0px 1px 1px; padding-top:9.5mm</xsl:with-param>								
							</xsl:call-template>
						</div>
						<!-- (8) ////////////////////////////////////////////////////-->
						<div class="styIRS8606LineItem"  style="height:8mm;">
							<div class="styIRS8606LNLeftNumBox">8</div>
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;">
									Enter the net amount you converted from traditional, traditional SEP, and traditional SIMPLE IRAs to Roth, Roth SEP, or Roth SIMPLE IRAs  
									in 2023.  Also, enter this amount on line 16
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">...................</span>
								</div>
							</div>
							<xsl:call-template name="CreateBox">
								...
								<xsl:with-param name="AmountBoxStyle">border-width:0px 0px 1px 1px; padding-top:4mm</xsl:with-param>
								<xsl:with-param name="NumberBoxStyle">border-width:0px 0px 1px 1px; padding-top:4mm</xsl:with-param>								
							</xsl:call-template>
						...
						<div class="styIRS8606LineItem"  style="height:4.5mm;">
							...
							<div class="styIRS8606LNDesc" style="width:107mm;height:4.5mm;padding:1mm 0 0 3mm;">
								<span style="float:left;">
									Add lines 6, 7, and 8
								</span>
								<!--Dotted Line-->
						...
						<div class="styIRS8606LineItem"  style="height:auto;">
							...
							<div class="styIRS8606LNDesc" style="width:105mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;">
									...
									<span style="float:left;">Roth, Roth SEP, or Roth SIMPLE IRAs. Also, enter this amount on line 17</span>
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">....</span>
								</div>
							</div>
						...
						<div class="styIRS8606LineItem"  style="height:auto;">
							...
							<div class="styIRS8606LNDesc" style="width:105mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;">
									...
									<span style="float:left;">convert to a Roth, Roth SEP, or Roth SIMPLE IRA</span>
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">..........</span>
								</div>
							</div>
						...
						<div class="styIRS8606LineItem"   style="height:auto;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:1mm 0 0 3mm;">
								<span style="float:left;">
									Subtract line 13 from line 3. This is <b>your total basis in traditional IRAs for 2023 and earlier years</b>
								</span>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:1mm;">......</span>
							</div>
							...
							<div class="styLNDesc" style="float:left;width:142mm;padding-left:2mm;height:5mm;">
							      Enter the amount on line 15a attributable to qualified disaster distributions, if any, from 2023 Form(s) 8915-F (see instructions). Also, enter this amount on 2023 Form(s) 8915-F, line 18, as applicable (see instructions)
						          <span class="styDotLn" style="float:right;padding-right:1mm;">..........</span>
						     </div>
							...
							<div class="styLNDesc" style="width:142mm;padding-left:2mm;height:3mm;text-align:left">
							   <b>Taxable amount. </b>Subtract line 15b from line 15a. If more than zero, also include this 
						         amount on<br/> 2023 Form 1040, 1040-SR, <b>or</b> 1040-NR, line 4b
						          <span class="styDotLn" style="float:right;padding-right:1mm;">......................</span>
						     </div>
					...
					<div style="width:187mm;padding-top:1mm;clear:all;page-break-after:always;display:block;">
						...
						<div style="float:right;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">8606</span> (2023)
						</div>
					</div>
					...
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">
							Form 8606 (2023)<span style="width:148mm;"/>
						</div>
						<div style="float:right;">
					...
					<div style="width:187mm;height:auto;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;padding-bottom:3px;height:auto;">
							2023 Conversions From Traditional, traditional SEP, or traditional SIMPLE IRAs to Roth, Roth SEP, or Roth SIMPLE IRAs<br/>
							<span class="styNormalText">
								Complete this part if you converted part or all of your traditional, traditional SEP, and traditional SIMPLE IRAs to a Roth, Roth SEP, or Roth SIMPLE IRA in 2023.
							</span>
						</div>
					</div>
					<!-- Body -->
						...
						<div class="styIRS8606LineItem" style="height:auto;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;font-size:7pt;">
									...
									converted from traditional, traditional SEP, and traditional SIMPLE IRAs to Roth, Roth SEP, or Roth SIMPLE IRAs in 2023
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">..........</span>
								</div>
							</div>
						...
						<div class="styIRS8606LineItem" style="border-bottom-width:0px;height:auto;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;">
									...
									2023 Form 1040, 1040-SR, or 1040-NR, line 4b
					...
					<div style="width:187mm;border-top-width:0.3mm;height:auto;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;height:auto;">
							Distributions From Roth, Roth SEP, or Roth SIMPLE IRAs<br/>
							<span class="styNormalText">
								Complete this part only if you took a distribution from a Roth, Roth SEP, or Roth SIMPLE IRA in 2023. For this purpose, a distribution does not
								include a rollover (other than a repayment of a qualified disaster distribution from 2023 Form(s) 8915-F (see instructions)), qualified charitable distribution,  one-time distribution to fund an HSA, recharacterization, or return of certain contributions (see instructions).
							</span>
						</div>
					</div>
					<!-- Body -->
					...
					<div class="styIRS8606LineItem" style="height:auto;">
						...
						<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:1mm 0 0 3mm;">
								Enter your total nonqualified distributions from Roth, Roth SEP, or Roth SIMPLE IRAs in 2023, including any
								qualified first-time homebuyer distributions, and any qualified disaster distributions from 2023 Form(s) 8915-F (see instructions)
					...
					<div class="styIRS8606LineItem" style="height:auto;">
						...
						<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:0.5mm 0 0 0;">
							<span style="float:left;padding-left:3mm;">
								Enter your basis in Roth, Roth SEP, or Roth SIMPLE IRA contributions (see instructions). If line 21 is zero, <b>
							stop here</b>
							</span>				
						    <!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">..</span>		
					...
					<div class="styIRS8606LineItem"   style="height:auto;">
						...
						<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
							<div class="styIRS8606LNDesc" style="width:auto;height:100%;">
								Enter your basis in conversions from traditional, traditional SEP, and traditional SIMPLE IRAs and rollovers from qualified retirement plans to a 
								Roth, Roth SEP, or Roth SIMPLE IRA. See instructions
							   <!--Dotted Line-->
							   <div class="styDotLn" style="float:right;padding-right:1mm;">.............</div>
							</div>
						</div>
					...
					<!--(25a- 25c)  ////////////////////////////////////////////////////-->
					     <div style="width:187mm">
							...
							Enter the amount on line 25a attributable to qualified disaster distributions, if any, from 2023 Form(s) 8915-F (see instructions). 
						...
						<b>Taxable amount.</b> Subtract line 25b from line 25a. If more than zero, also include this 
                                  amount on 2023 Form 1040, 1040-SR, <b>or</b> 1040-NR, line 4b.
						          <span class="styDotLn" style="float:right;padding-right:1mm;">..................</span>
						     </div>
