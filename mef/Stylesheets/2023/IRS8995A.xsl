		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form id="Form8995A">
					...
					<br/>
					<span style="width:10px;"></span>Use this form if your taxable income, before your qualified business income deduction, is above $170,050 ($340,100 if married filing jointly), or you’re a patron of an agricultural or horticultural cooperative.
						</div>
					<!-- Part 1 -->
						...
						<xsl:if test="position() mod 3 = 1">
							...
							<div class="styStdIBDiv">
								...
								<div class="sty8995ADesc" style="height:10mm;">
									Multiply line 2 by 20% (0.20). If your taxable income is $170,050 or less 
									($340,100 if married filing jointly), skip lines 4 through 12 and enter the amount from line 3 on line 13
									<span class="sty8995ADotLn">..</span>
								</div>
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;">Form <span style="font-weight:bold;font-size:larger;">8995-A</span> (2023)</span>
					</div>
					<div class="styStdDiv">
						Form 8995-A (2023)
