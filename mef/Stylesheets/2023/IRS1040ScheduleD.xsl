        ...
        <form name="Form1040ScheduleD">
          ...
          <div class="styBB" style="width: 187mm;">
            ...
            <div class="styFTBox" style="width:130mm;height:20mm;">
              ...
              <div>
                <span style="font-weight: bold;height: 4mm;">
                  Go to <a href="http://www.irs.gov/form1040" title="Link to IRS.gov"><i>www.irs.gov/ScheduleD</i></a> for instructions and the latest information.
				</span>
              </div>
            </div>
            <!-- Tax Year Box -->
            <div class="styTYBox" style="width:31mm;height:20mm;">
              ...
              <!-- Tax Year -->
              <div class="styTaxYear" style="height:8mm;">20<span style="color:green;">23</span>
              </div>
          ...
          <!-- END FORM HEADER -->
          <!-- BEGIN TAXPAYER INFO -->
          <div class="styBB" style="width:187mm;float:left;clear:none;height:7mm;">
            <!-- Name -->
            <div class="styNameBox" style="width:136mm;font-size:7pt;font-weight:normal;">
...
<div class="styIRS4835CleanDiv" style="width:28mm;float:right;">
          ...
          <div class="styGenericDiv" id="STCapGainTableContainer">
            <table class="IRS1040ScheduleD_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
              ...
              <tr>
                <th class="IRS1040ScheduleD_styTableCellNote" style="font-weight:normal;height:20mm;" scope="col">
                ...
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;height:20mm;" scope="col">
                ...
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;border-right-width:0px;height:20mm;" scope="col">
          ...
          <div class="styBB" style="width:187mm;height:8mm;">
			  ...
			  <div class="styLNRightNumBox" style="height:8mm;border-bottom-width:0px; padding-top:3mm">15</div>
			  <div class="styLNAmountBox" style="height:8mm;border-bottom-width:0px;padding-top:3mm">
				  <xsl:call-template name="PopulateAmount">
          ...
          <div class="stySmallText" style="width:110mm;">
           <span class="styBoldText">For Paperwork Reduction Act Notice, see your tax return instructions.</span>
            ...
            <div class="stySmallText" style="width:55mm;text-align:right;"><span class="styBoldText">Schedule D (Form 1040) 2023</span>
                   </div>
          </div>
          
        <!--Begin Page 2 -->
        <div class="styBB" style="width:187mm; border-bottom-width:1px; margin-top:2mm">
          <span style="width:65mm;font-size:7pt;" class="styGenericDiv">Schedule D (Form 1040) 2023</span>
       ...
       <div class="styBB" style="width:187mm;border-bottom-width:0px;">
        ...
        <span style="font-weight:bold;padding-left:1mm;">No.</span>
           ...
           Complete the rest of Form 1040, 1040-SR, or 1040-NR.			
			</div>
          <div class="styLNRightNumBox" style="width:8.2mm;background-color:lightgrey;border-bottom-width:0px;height:8mm"/>
        ...
        <div class="styBB" style="width:187mm;border-top-width: 1px;border-bottom-width:0px;">
          <span style="font-weight:bold;float:right" class="styGenericDiv">Schedule D (Form 1040) 2023</span>
        </div>
        <!--  PART III HEADER -->

        <div class="styLeftOverTitleLine" id="LeftoverData" style="margin-top:2mm">
