...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<!-- 03/05/2024 AC: Per UWR 973445, IRS943_943PR is being discontinued, all SSPR references are removed-->
	<!-- Spanish related coding will not be triggered but they remain for now, since -->
	<!-- most of it will be incorporated again in UWR 978192 in R10.8-->
	...
	<xsl:variable name="FormUpperRightNumber">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">430123</xsl:when>
			<xsl:otherwise>430123</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line1Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">Number of agricultural employees employed in the pay period that includes March 12, 2023</xsl:when>
			<xsl:otherwise>Número de empleados agrícolas durante el período de nómina que incluye el 12 de marzo de 2023</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line14aText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Total deposits for 2023, including overpayment applied from a prior year and Form 943-X&lt;/span&gt;</xsl:when>
			<xsl:otherwise>Total de dep&amp;#243;sitos hechos en 2023, incluyendo todo exceso pagado y aplicado de un a&amp;#241;o anterior&lt;br/&gt;&lt;span style="float:left"&gt;y cantidad pagada en exceso aplicada del Formulario 943-X (PR)&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line14hText">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left"&gt;Total deposits and refundable credits. Add lines 14a, 14d, and 14f&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line15Text">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;b&gt;Saldo adeudado.&lt;/b&gt; Si la l&amp;#237;nea &lt;b&gt;13&lt;/b&gt; es mayor que la l&amp;#237;nea &lt;b&gt;14h&lt;/b&gt;, anote la diferencia y vea las instrucciones</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
...
<!--								<xsl:if test="$Language='SPANISH'">
					...
					<div class="styFNBox" style="border-right:0px solid black;width:30mm;padding-left:1mm;padding-top:0mm;font-size:6px;">
						*Include taxable qualified sick and family leave wages paid in 2023 for leave taken after March 31, 2021, and before
						 October 1, 2021, on line 2. Use lines 2a and 2b <b>only</b> for taxable qualified sick and family leave wages paid 
						 in 2023 for leave taken after March 31, 2020, and before April 1, 2021.
						</div>	
					</div>	
					...
					<xsl:if test="$Language='SPANISH'">
						<div class="styBB" style="width:187mm;padding-bottom:.5mm;float:none;clear:both;border-bottom-width:0px">
							...
							<div class="styLNDesc" style="width:141mm;float:left;">
								<span style="float:left;">
									<b>Cantidad pagada en exceso.</b> Si la línea <b>14h</b> es mayor que la línea <b>13</b>, anote la diferencia</span>
								<!--Dotted Line-->
								<img style="float:right;padding-right:3.0mm;padding-top:.5mm;" src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Right pointing arrowhead image"/>
								<span class="styDotLn" style="float:right;">.....</span>
							</div>
