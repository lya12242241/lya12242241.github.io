  ...
  <div class="styBB" style="height: 21.5mm;width:187mm;">
    <div class="styFNBox" style="height: 21.5mm;width:26mm;font-size: 7pt;">
      ...
      <span>
       ...
       <br/>
      <span class="styAgency">(Rev. December 2023)</span>
...
<div class="styGenericDiv" style="width:187mm;padding-top:0.5mm;font-style:italic;clear:all;border-bottom-width:1px;border-bottom-style:solid;">
						<b>Note:</b> A contractor must own and have a basis in the qualified new energy efficient home during its
    ...
    <div style="width:187mm;">
        ...
        <div class="styLNDesc" style="width:92mm;height:18.5mm;">Enter the total number of qualified new energy efficient homes that were 
		eligible to participate in the Energy Star Residential New Construction Program or the Energy Star Manufactured New Homes Program meeting the single-family home requirements but not certified as a zero energy ready home that were
        ...
        <div class="styLNAmountBox" style="height:19.5mm;padding-top:16.0mm;">
    ...
    <div style="width:187mm;">
        ...
        <div class="styLNAmountBox" style="height:16.5mm;padding-top:12.5mm;">
        ...
        <div class="styLNAmountBoxNBB" style="height:16.5mm;"/>
    </div>
    ...
    <div style="width:187mm;">
      ...
      <div style="width:187mm;">
        ...
        <div class="styLNAmountBox" style="height:15.5mm;padding-top:12.5mm;">
        ...
        <div class="styLNAmountBoxNBB" style="height:15.5mm;"/>
    </div>
   ...
   <div style="width:187mm;">
    ...
    <div style="width:187mm"> 
        ...
        <span style="width:64.5mm;text-align:right;">Form 
			<span style="font-size:8pt"><b>8908</b></span> (Rev. 12-2023)
        </span>
    </div>
    <br class="pageEnd"/>
