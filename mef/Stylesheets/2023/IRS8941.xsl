...
<!-- Last Modified by iskiu lawal 5/18/2023 UWR # 971641 drop3 R10.7 -->
...
(SHOP) Marketplace (or do you qualify for an exception to this requirement)? See instructions.<br/>
  ...
  Enter Marketplace Identifier (if any): 
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:170mm;height:20mm;font size:7pt;">Does a tax return you (or any predecessor) filed for a tax year beginning after 2013 and before 2022 include a Form 8941 with line A checked "Yes" and line 12 showing a positive amount? See instructions.<br/>
							<!-- CheckboxYesStart -->
							<span>
                             <xsl:call-template name="PopulateSpan">
 ...
 Stop. Do not file Form 8941 (see instructions for an exception that may apply to a partnership, S corporation, cooperative, estate, trust, or tax-exempt entity) (also see instructions for information about the credit period limitation)
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;font size:7pt">Average annual wages you paid for the tax year (from Worksheet 3, line 3).This amount must be a multiple of a $1,000. If you entered $62,000 or more, skip lines 4 through 11 and enter -0- on line 12
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>.
								<span style="width:8px"/>.
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:4mm;font size:7pt">If line 3 is $30,000 or less, enter the amount from line 8. Otherwise, enter the amount from Worksheet 6, line 7
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>.
                                    <span style="width:8px"/>.
...
3800,  Part III, line 4h
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;font size:7pt">Enter the amount you paid in 2023 for taxes considered payroll taxes for purposes of this credit. <br/>  See instructions.
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>. 
                                    <span style="width:8px"/>.
