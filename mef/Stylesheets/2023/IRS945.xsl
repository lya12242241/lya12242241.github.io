			...
			<body class="styBodyClass" style="width:187mm">
				<form name="Form945">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;">
						...
						<div class="styLNDesc" style="width:138.8mm;">Total deposits for 2023, including overpayment applied from a prior year and overpayment applied from<br/>
					...
					<div style="width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;float:none;clear:both;">
						...
						<div style="height:9mm;float:left;clear:none;width:172mm;padding-top:2mm;">
							...
							<div style="float:left;clear:none;width:35mm;padding-top:3mm;">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							...
							<span class="styBoldText" style="font-size:8pt;">945 </span> (2023)
						</div>
					</div>
