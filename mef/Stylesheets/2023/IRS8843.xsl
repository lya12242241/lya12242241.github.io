				...
				<form id="Form8840">
					...
					<div class="styStdDiv" style="border-bottom:2px solid black;display:inline-block;">
						...
						<div class="styTYBox" style="width:28mm;height:23mm;">
							...
							<div class="styTaxYear" style="width:100%;">20<span class="styTYColor" style="display:inline;">23</span>
							</div>
							<div style="width:100%;">
					...
					<!-- Begin Form -->
					<div class="styStdDiv">
						<div class="styNameBox" style="width:100mm;height:6mm;border-right-width:1px;">
						...
						<div class="styStdDiv">
							...
							<div class="sty8843DescA" style="width:179mm;">
								<span style="width:158.5mm;float:left;">
									For teachers, enter the name, address, and telephone number of the academic institution where you taught in 2023:
								</span>
						...
						<div class="styStdDiv">
							...
							<div class="sty8843DescA" style="width:179mm;">
								...
								<span style="width:48.5mm;float:left;">
									you participated in during 2023:
								</span>
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							During 2023, did you apply for, or take other affirmative steps to apply for, lawful permanent resident status <br/>
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<div style="float:right;">
							...
							Form <span style="font-weight:bold;font-size:8pt;">8843</span> (2023)
						</div>
					</div>
					<!-- Page 2 -->
					<div class="styStdDiv">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							Enter the name of the charitable sports event(s) in the United States in which you competed during 2023 and the dates of <br/>
