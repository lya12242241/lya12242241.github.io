			...
			<body class="styBodyClass">
				<form id="Form8995AScheduleA">
					...
					<div class="sty8995ASALineDiv">
						...
						<div class="styFTBox" style="width:127mm;height:22.5mm;">
							...
							<span style="font-weight:bold;">
								<img src="{$ImagePath}/Small_Right_Pointing_Arrow.gif" alt="Right Arrow Image"/> Attach to Form 8995-A.
							</span>
							<br/>
							<span style="font-weight:bold;">
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;font-weight:bold;">Schedule A (Form 8995-A) 2023</span>
					</div>
