			...
			<body class="styBodyClass">
				...
				<form name="IRS990EZ">
					...
					<div class="styComType" style="width:187mm;border-bottom-width: 0px; font-size: 7pt">
						...
						<div class="styBoldText" style="height:auto;width:182mm;float:left;clear:none;">For the 2023 
...
<table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
    ...
    Form <span class="styBoldText" style="font-size: 8pt;"> 990-EZ </span> (2023)
					...
					<div style="width:187mm;padding-top:1mm;">
						...
						<div style="float: left; clear: none">Form 990-EZ (2023)</div>
...
-->
	...
	<!-- </label> -->
					...
					<div style="width:187mm;">
						...
						<span style="float: right">Form <span class="styBoldText">990-EZ</span> (2023)</span>
