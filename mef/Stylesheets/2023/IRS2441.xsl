	...
	<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
						...
						<xsl:call-template name="SetFormLinkInline">
							...
							<span class="styAgency">Internal Revenue Service (99)</span>
									...
									<div class="styTYBox" style="width:31mm; height:20mm;border-left-width:2px;">
										...
										<div class="styTaxYear" style="font-size:21pt;border-top:1px solid black;width:26mm;">20<span class="styTYColor" style="font-			 size:21pt:">23</span>
										</div>
					...
					<div class="styBB" style="width:187mm;font-size:7pt;border-bottom-width:2px;height:9mm;">
						<div class="styFNBox" style="width:187mm; height:7mm;border-right-width: 0px;">
							<xsl:call-template name="PopulateLabel">
								<xsl:with-param name="TargetNode" select="$Form2441Data/EligibilityRequirementMetInd"/>
								<xsl:with-param name="BackupName">Eligbility requirement met indicator</xsl:with-param>
							</xsl:call-template><b>B</b> If you or your spouse was a student or was disabled during 2023 and you're entering deemed income of $250 or $500 a month on Form 2441 based on the income rules listed in the instructions under <i>If You or Your Spouse Was a Student or Disabled,</i> check this box.
					  <input type="checkbox" alt="StudentOrDisabledInd" class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styBB" style="width:187mm;height:8mm;">
							...
							<div class="styPartDesc" style="padding-left:1mm;width:168mm;font-size:8pt;">
								...
								<span class="styNormalText" style="padding-left:0mm;font-size:8pt;">If you have more than three care providers, see the instructions and check this box.</span>
								 <input type="checkbox" alt="MoreThanThreeCareProvidersInd" class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
       ...
       Care provider's <br/>
										...
										<th class="styTableCellHeader" scope="col" colspan="1" style="width:30mm;font-weight:normal;height:9mm;  border-color:black;vertical-align:top;">
											<span style="font-weight:bold;">(d)</span> Was the care provider your household employee in 2023?.<br/>(see instructions)
     </th>
										 <th class="styTableCellHeader" scope="col" colspan="1" style="width:30mm;font-weight:normal;height:9mm;  border-color:black;vertical-align:top;">
								...
								<tbody>
									...
									<xsl:with-param name="TargetNode" select="$Form2441Data/CareProviderGrp/HouseholdEmployeeInd"/>
								</xsl:call-template>
...
Did you receive<br/>
						...
						<div class="styPartDesc" style="font-weight:Normal;width:187mm;padding-top:2mm;font-size:8pt;height:13mm;padding-left:0mm;">
							<b>Caution.</b> If the care was provided in your home, you may owe employment taxes. For details, see the Instructions for Schedule H (Form 1040). If you incurred care expenses in 2023 but didn't pay them until 2024, or if you prepaid in 2023 for care to be provided in 2024, don't include these expenses in column (d) of line 2 for 2023. See instructions.</div>
						<!-- BEGIN PART II TITLE -->
									...
									<tr>
										...
										<th class="styTableCellHeader" scope="col" colspan="1" style="width:50mm;font-weight:normal;  height:6mm;border-color:black;">
											<span style="">
												...
												<span class="styBoldText">Qualified expenses</span> you<br/> incurred and paid in 2023 for the person listed in column (a)</span>
										</th>
									</tr>
								</thead>
								<tfoot/>
										...
										<xsl:for-each select="$Form2441Data/QualifyingPersonGrp">
											<tr>
												...
												<td class="styTableCell" style="width:30mm;  border-color:black;text-align:left;vertical-align:top;">
													<span>
														<xsl:call-template name="PopulateSpan">
															<xsl:with-param name="TargetNode" select="$Form2441Data/QualifyingPersonGrp/PrsnOverSpcfdAgeAndDisabledInd"/>
														</xsl:call-template>
						...
						<div class="styNBB" style="width:187mm;height:40mm;font-size:6.5pt;">
							<span style="float:left;">
								...
								<div class="styLNDesc" style="width:123mm;">
									...
									<span style="width:7mm"/><b>$0--15,000</b> <span style="width:18mm"/> <b>.35</b><span style="width:18mm"/><b>$29,000--31,000</b> <span style="width:10mm"/> <b>.27</b><br/>
						...
						<!--<div style="width:187mm;">
						    ...
						    &#8226;<span style="width:120mm;padding-left:2mm;height:2mm;"> If line 7 is over $438,000, you can’t claim this credit; don’t complete lines 8 through 11.</span>
						   </div>
							...
							<img src="{$ImagePath}/2441_if_chart.jpg" alt="If chart" height="200" width="500"/>
						</div>-->
						...
						<div style="width:187mm;">
							<!--<div class="styLNLeftNumBox" style="height:26mm;width:49px;background-color:yellow"/>-->
							
							<!--<div style="width:56mm;height:18mm;float:right;background-color:yellow">-->
								<!--<div class="styLNAmountBoxNBB" style="height:100%;border-left-width:0px;width:16mm;float:left;"/>-->

								<!--<div class="styLNRightNumBoxNBB" style="height:18mm;border-right-width:1px;background-color:lightgrey;"/>-->
								<!--<div class="styIRS2441RightSpaceBox" style="height:18mm;"/>-->
								<div style="height:4.5mm;width:56mm;float:right;">	
									<div class="styLNRightNumBoxNBB" style="height:100%;border-right-width:0px;border-bottom-width:1px;padding-top:0mm;border-top-width: 1px;">  8                  
		                            </div>
									<div class="styLNAmountBox" style="height:100%;border-left-width:1px;width:47.5mm;padding-top:0mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:123mm;height:5mm;">If you paid 2022 expenses in 2023, complete Worksheet A in the instructions. Enter the amount from line 13 of the worksheet here. Otherwise, go to line 9c
                             <!--CPYECreditAmt-->
									<xsl:call-template name="SetFormLinkInline">
						...
						<!--line 9c-->
					<div style="width:187mm;">
							<div class="styLNLeftNumBox" style="height:4mm;padding-top:2.5mm;"><span style="width:1.5mm"/>9c
                            </div>
						...
						<!--Line 10-->
						<div style="width:187mm;">
							<div class="styLNLeftNumBox" style="height:4mm;"><span style="width:1.5mm"/>10
                        </div>
					...
					<div class="stySmallText" style="width:36mm;text-align:right;">Form <span class="styBoldText">2441</span> (2023)
                   </div>
					</div>
					<!--End Footer-->
					<!-- Page Header -->
					<div style="width:187mm;padding-top:0.5mm;">
						<div style="float:left;">Form 2441 (2023)<span style="width:148mm;"/>
						</div>
					...
					<div style="width:187mm;clear:all;">
						...
						you received in 2023. Amounts you<br/> received as an employee should be shown in box 10 of your Form(s) W-2. 
					...
					<!--line 13-->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:6mm;padding-top:1mm;font-size:7pt;">13
                      </div>
						<div class="styLNDesc" style="width:123mm;height:6mm;padding-top:1mm;">Enter the amount, if any, you carried over from 2022 and used in 2023 during the grace period. See instructions
						</div>
                        <div class="styLNRightNumBox" style="height:6mm;border-right-width:0px;padding-top:2.5mm;">13                    
                        </div>
						<div class="styLNAmountBox" style="height:6mm;border-left-width:1px;width:48mm;padding-top:2.5mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:123mm;height:7mm;padding-top:1mm;">If you forfeited or carried over to 2024 any of the amounts reported on line 12 or 13, enter the amount. See instructions
							<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">......................</span>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:91mm;height:4mm;">
							<span style="width:8mm"/>in 2023 for the care of the <span class="styBoldText">qualifying person(s)</span>
							<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">.....</span>
						</div>
   ...
   If married filing jointly, enter your<br/>
								...
								<span style="width:2mm"/>see the instructions for lines 4 and 5).
							</span><br/>
							<span style="text-align:left;">
								<img src="{$ImagePath}/2441_Bullet_Round.gif" alt="MediumBullet"/> 
  If married filing separately, see<br/>
		...
		<div class="styLNDesc" style="width:83mm;padding-top:0mm;height:11mm;">Enter $5,000 ($2,500 if married filing separately <b>and</b> <br/>you were required to enter your spouse&#8221;s earned <br/>income on line 19). However, don't enter more than the maximum amount allowed under your dependent care plan, see instructions
							<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">................</span>
						</div>
						<div class="styLNRightNumBox" style="height:7.0mm;border-right-width:0px;background-color:lightgrey;border-bottom-width:0px;">                  
                            </div>
                            <div class="styLNAmountBox" style="height:7.0mm;border-left-width:1px;width:32mm;border-bottom-width:0px;">
						</div>
							<div class="styLNRightNumBoxNBB" style="height:7mm;border-right-width:0px;background-color:lightgrey;"/>
						<div class="styIRS2441RightSpaceBox" style="height:7mm;width:48mm;border-right-width:0px;"/>
						<div class="styLNRightNumBox" style="height:8.5mm;border-right-width:0px;padding-top:5mm;">21                  
                            </div>
						<div class="styLNAmountBox" style="height:8.5mm;border-left-width:1px;width:32mm;padding-top:5mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;height:10mm;">
						...
						<div class="styLNRightNumBox" style="height:10.5mm;border-right-width:0px;padding-top:6.5mm;border-bottom-width:2px;">25                     
                            </div>
					...
					<div style="width:187mm;">
						...
						You can't take the credit. <br/><b>Exception.</b> If you paid 2022 expenses in 2023, see the instructions for line 9b
							<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">.....</span>
						</div>
					...
					<div class="pageEnd" style="width:187mm; border-top:0.5mm solid black;">
						<div style="float:right;">
							<span style="width:80px;"/>  
                             Form <span class="styBoldText">2441</span> (2023)
                    </div>
					</div>
					<!--END Page Footer-->
