...
<!-- Updated By Iskilu Lawal 03/16/2023 UWR # 966512  -->
							...
							<div class="styIRSW2ASCleanDiv" style="width:28%;height:100%;">
								<div class="styIRSW2ASLNDesc" style="width:100%;font-size:8pt;padding-left:5px;">
									...
									<div class="styIRSW2ASCleanDiv" style="width:auto;border-left-width:0px;padding-left:5px;">
										<img src="{$ImagePath}/W2AS_Bullet.gif" alt="Right Arrow Image"/>
									</div>
                        ...
                        overflow:visible;
							...
							<div style="width:24.85%;float:right;height:auto;">
								<div class="styIRSW2ASCleanDiv" style="width:auto;height:auto;border-width:0px 0px 0px 0px;">
									...
									<div class="styIRSW2ASLNDesc" style="width:35.3mm;height:auto;">See instructions for box 12</div>
