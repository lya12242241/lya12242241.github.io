				...
				<!-- ******************************************************************************************************* -->		
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px;">
						...
						<div class="styFTBox" style="width:123mm;height:19mm;">
							...
							<div class="styFST" style="height:5mm;text-align:center;padding-top:1mm;">For calendar year 2023 or tax year beginning
					...
					<p>
						<div class="pageEnd" style="width:187mm;padding-top:0mm;border-top-width:1px;">
							...
							<div style="float:right;">
								<span style="width:40px;"/>Form <span class="styBoldText" style="font-size:8pt;">1120</span> (2023)
                           </div>
						</div>
					</p>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1120 (2023)<span style="width:148mm;border-bottom-width:5mm"/>
						</div>
					...
					<!-- Page Header -->
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1120 (2023)<span style="width:148mm;"/>
						</div>
					...
					<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:136mm;height:4.5mm;padding-top:.6mm;">
								<span style="float:left;padding-top:0.3mm;">Income tax. See instructions
								 <!-- Form to Form Link -->
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Schedule J Line 1 - Section 1291 Indicator</xsl:with-param>
										<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@section1291Cd"/>
									</xsl:call-template>
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Schedule J Line 1 - Section 1291 Amount</xsl:with-param>
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Schedule J Line 1 - Section 8978 Indicator</xsl:with-param>
										<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@form8978Cd"/>
									</xsl:call-template>
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Schedule J Line 1 - Section 8978 Amount</xsl:with-param>
						...
						<div style="float:right;clear:none;">
							<div class="styLNRightNumBox" style="height:5.25mm;padding-top:1mm;">1</div>
						...
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc">
								<span style="float:left;">
			                        ...
			                        <span style="width:2mm;"/>Add lines 19,21, and 22.  Enter here and on page 1, line 33			                        	
								</span>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:1mm;">.....</span>
							</div>
				...
				<!-- BEGIN SCHEDULE K -->
					<p>
						<div class="pageEnd" style="width:187mm;padding-top:1mm;">
							<div style="float:right;">
								<span style="width:80px;"/>Form <span class="styBoldText" style="font-size:8pt;">1120</span> (2023)
							</div>
						</div>
					</p>
					<!-- END Page Break and Footer-->
...
classes of the corporation’s stock entitled to vote or at least 25% of the total value of all classes of the corporation’s stock? 
					...
					<div  style="width:187mm;height:6mm;">
						<div class="styLNLeftNumBox" style="padding-left:4mm;">b</div>
						<div class="styLNDesc" style="width:167mm;">
							<span style="float:left;">The corporation's aggregate average annual gross receipts (determined under section 448(c)) for the 3 tax years preceding the current tax year are $29 million or more and the corporation has business interest expense.
							</span>		
						</div>
						<div class="styGenericDiv">
							<div class="styShadingCell" style="width:6mm;height:8mm;"/>
...
<span style="float:left;">adjustment, as described in the instructions, of $10 million or more?
					...
					<div class="pageEnd" style="width:187mm;">
						<div style="float:right;">
							<span style="width:80px;"/>
								Form 
							<span class="styBoldText" style="font-size:8pt;">1120</span> (2023)
					    </div>
					</div>
					</p>
					<!-- END Page Break and Footer-->
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;border-top:1 solid black;border-top-width1px;">
						...
						<div style="float:right;">
							<span style="width:80px;"/>  
                            Form <span class="styBoldText" style="font-size:8pt;">1120</span> (2023)
                        </div>
					</div>
					<!-- END Page Break and Footer-->
					...
					<table class="styLeftOverTbl">
						...
						<xsl:call-template name="PopulateLeftoverRow">
							...
							Form 1120, Page3, Schedule J, Line 1 - Section 1291 Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@section1291Cd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							...
							Form 1120, Page3, Schedule J Line 1 - Section 1291 Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@section1291Amt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							...
							Form 1120, Page3, Schedule J Line 1 - Section 197 Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@section197Cd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
						...
						<!--	Form 1120, Page 2, Schedule J Line 2 - Section 197 Amount</xsl:with-param>-->
							Form 1120, Page 3, Schedule J Line 1 - Section 197 Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@section197Amt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
						...
						<!--	Form 1120, Page 2, Schedule J Line 2 - Section 8978 Indicator</xsl:with-param>-->
							Form 1120, Page 3, Schedule J Line 1 - Section 8978 Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@form8978Cd"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							...
							Form 1120, Page 3, Schedule J Line 1 - Section 8978 Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@form8978Amt"/>
							<xsl:with-param name="DescWidth" select="100"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Form 1120, Page 3, Schedule J, Part I, Line 9b - Form 8693 Approved Indicator
							</xsl:with-param>
