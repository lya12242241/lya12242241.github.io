...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
			...
			<body class="styBodyClass">
				<form name="Form6252">
					...
					<div class="styTBB" style="width:187mm;height:21.5mm;">
						...
						<div class="styFTBox" style="width:132mm;height:21.5mm;">
							<div class="styMainTitle" style="padding-top:1.5mm;">Installment Sale Income</div>
							<br/>
							
							<div class="styFST" style="font-size:7pt;padding-top:1.5mm;">
              ...
              <br/>
                ...
                <i>www.irs.gov/Form6252 </i>
						...
						<!-- Close middle box -->
						<!--Right Title box -->
						<div class="styTYBox" style="width:28mm;height:21.5mm;">
							<div class="styOMB" style="height:4mm;">OMB No. 1545-0228</div>
							<div class="styTaxYear" style="height:9mm;font-size:22pt;">20<span class="styTYColor">23</span>
						</div>
							<div class="styOMB" style="height:3mm;border-bottom-width:0px;text-align:left;padding-left:4mm;">
                Attachment<br/>Sequence No. <span class="styBoldText">67</span>
							</div>
						</div>
              ...
              <br/>
					...
					<div class="styBB" style="width:187mm;">
						<div style="width:187mm;">
						   ...
						   <div class="styLNDesc" style="width:39mm;">
								<div  style="width:29mm;">Description of property</div>
								<div  style="width:4mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:52mm;">Date acquired (mm/dd/yyyy)
								<!--<img src="{$ImagePath}/6252_Bullet.gif" alt="Medium Right Arrow Image"/>-->
								<br/>
							</div>
                  ...
                  <!--<img src="{$ImagePath}/6252_Bullet.gif" alt="Medium Right Arrow Image"/>-->
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:148mm;height:6mm">
								<span style="float:left;">Was the property sold to a related party? See instructions. If “Yes,” complete Part III for the year of sale and 2 years after the year of the sale unless you received the final payment during the tax year. 
									<div class="styDotLn" style="float:right;padding-right:0.5mm;">..........</div> 
								</span>
								<!--Dotted Line-->
							</div>
							<div class="styLNDesc" style="width:15mm;height:6mm;padding-top:2mm;padding-left:2mm;">
								<span>
							...
							<div class="styLNDesc" style="width:15mm;text-align:right;height:6mm;padding-top:2mm;float:right;clear:none;">
								<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$Form6252Data/PropertySoldToRelatedPartyInd"/>
									</xsl:call-template>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:148mm;height:6mm;padding-top:2mm;">
								Reserved for future use. 
								<!--<span style="float:left;"></span>-->
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;.5mm;">.............................</div>
							</div>
							<div class="styLNDesc" style="width:15mm;text-align:center; padding-top:1mm;">
								<span>
									<xsl:call-template name="PopulateSpan">
		...
		<xsl:with-param name="BackupName"> Yes Prop Sold Rltd Party Marketable Sec</xsl:with-param>		
							...
							<div class="styLNDesc" style="width:15mm;height:auto;text-align:right;padding-top:1mm;float:right;clear:none;">
								<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$Form6252Data/PropSoldRltdPartyMrktblSecInd"/>
									</xsl:call-template>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styPartDesc">Gross Profit and Contract Price.
							<span class="styNormalText"> Complete this part for all years of the installment agreement.</span>
						</div>
					</div>
					<!-- END Part I Title -->
					<!--Blank Line-->
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">Selling price including mortgages and other debts. 
						...
						<div style="width:187mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:98mm;">Mortgages, debts, and other liabilities the buyer assumed or took the 
						...
						<div style="width:187mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:139mm;">Subtract line 13 from line 5. If zero or less, <b>don't</b> complete the rest of this form.  See instructions
									<!--Dotted Line-->
									<div class="styDotLn" style="float:right;padding-right:1mm;">...</div>
								</div>
							</div>
						...
						<div style="width:187mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:139mm;">If the property described on line 1 above was your main home, enter the amount of your excluded gain.<br/> 
									See instructions.  Otherwise, enter -0- 
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">......................</div>
								</div>
							</div>
							...
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:139mm;">
									<span style="float:left;">
										<span class="styBoldText">Gross profit.</span> Subtract line 15 from line 14</span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">....................</div>
								</div>
							</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styPartDesc" style="height:auto;">
						  <span class="styNormalText"><span class="styBoldText">Installment Sale Income.</span> Complete this part all years of the installment agreement.
						  </span>
						</div>
					</div>
					<!-- END Part II Title -->
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:139mm;">Gross profit percentage (expressed as a decimal amount). Divide line 16 by line 18. (For years after the<br/> 
						...
						<div style="width:187mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:139mm;">
									<span style="float:left;">
										<span class="styBoldText">Installment sale income.</span> Multiply line 22 by line 19</span>
									<!--Dotted Line-->
									<div class="styDotLn" style="float:right;padding-right:1mm;">.................</div>
								</div>
							</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:148mm;padding-top:1.5mm;">Did the related party resell or dispose of the property ("second disposition") during this tax year?
							<!--Dotted Line-->
							<div class="styDotLn" style="float:right;padding-right:1mm;">......</div>
						</div>
						...
						<div class="styLNDesc" style="width:146mm;height:auto;">
							...
							<label>
								<xsl:call-template name="PopulateLabel">
									<xsl:with-param name="TargetNode" select="$Form6252Data/SndDisposMore2YrsAftrFirstInd"/>
									<xsl:with-param name="BackupName">Second Dispos More 2Yrs Than First</xsl:with-param>	
								</xsl:call-template>The second disposition was more than 2 years after the first disposition (other than dispositions <br/>
								<span style="width:5mm;"/>of marketable securities).  If this box is checked, enter the date of disposition (mm/dd/yyyy) 
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">......</div>
							</label>
						</div>
						...
						<div class="styLNDesc" style="width:158mm;">
							...
							<label>
								<xsl:call-template name="PopulateLabel">
									<xsl:with-param name="TargetNode" select="$Form6252Data/FirstDisposSaleExchangeStkInd"/>
								<xsl:with-param name="BackupName">First Dispos Sale Exchange</xsl:with-param>	
								</xsl:call-template>The first disposition was a sale or exchange of stock to the issuing corporation.
						   </label>
						</div>
					</div>
					<!--L29c-->
						...
						<div class="styLNDesc" style="width:178mm;">
							...
							<label>
								<xsl:call-template name="PopulateLabel">
									<xsl:with-param name="TargetNode" select="$Form6252Data/SecondDisposInvlntryCnvrtInd"/>
									<xsl:with-param name="BackupName">Second Dispos Involuntary Cnvrt</xsl:with-param>		
								</xsl:call-template>The second disposition was an involuntary conversion and the threat of conversion occurred after the first disposition.  
							</label>
						</div>
					</div>
					<!--L29d-->
						...
						<div class="styLNDesc" style="width:158mm;">
							...
							<label>
								<xsl:call-template name="PopulateLabel">
									<xsl:with-param name="TargetNode" select="$Form6252Data/SecondDisposAfterDeathSellrInd"/>
									<xsl:with-param name="BackupName">Second Dispos After Death Seller</xsl:with-param>					
								</xsl:call-template>The second disposition occurred after the death of the original seller or buyer.  
						  </label>
						</div>
					</div>
					<!--L29e-->
						...
						<div class="styLNDesc" style="width:178mm;height:auto;">
							...
							<label>
								<xsl:call-template name="PopulateLabel">
									<xsl:with-param name="TargetNode" select="$Form6252Data/NotToAvoidTaxInd"/>
									<xsl:with-param name="BackupName">Disposition Not To Avoid Tax</xsl:with-param>
								</xsl:call-template>It can be established to the satisfaction of the IRS that tax avoidance wasn't a principal purpose for either of the dispositions.<br/>
								<span style="width:5mm;"/>If this box is checked, attach an explanation. See instructions.                
						   </label>
							<span style="width:2px;"/>
							<!-- Form to Form Link -->
							<xsl:call-template name="SetFormLinkInline">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">Enter the <b>smaller</b> of line 30 or line 31      
 								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">......................</div>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;backg">Total payments received by the end of your 2023 tax year (see instructions) </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">..........</div>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">Enter the part of line 35 that is ordinary income under the recapture rules. See instructions  
   								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">.....</div>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">Subtract line 36 from line 35. Enter here and on Schedule D or Form 4797.  See instructions  
  								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">.....</div>
							</div>
              ...
              Form <span class="styBoldText">6252</span> (2023)
            </div>
					</div>
