...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
			...
			<body class="styBodyClass">
				<form name="Form1120&#8211;S">
					...
					<div class="styBB" style="width:187mm;">
						For calendar year 2023<span style="width: 1mm"/>or tax year beginning
					...
					<div class="styBB" style="width:187mm;">
						...
						expenses on lines 1a through 22. See the instructions for more
						information.
					</div>
					<!-- Income vertical image -->
					<div class="styBB" style="width:187mm;">
						<div class="styIRS1120SVTImageBox" style="height:32mm;padding-top:12mm;">
						...
						<div class="styGenericDiv" style="width:181mm;height:4.5mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:36mm;height:4.5mm;">
							...
							<div style="clear:none;">
								...
								<div class="styLNDesc" style="width:42mm;height:4.5mm;padding-left:2mm;"><b> b </b>  Less returns and allowances</div>
								<div class="styLNAmountBox">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1120SData/ReturnsAndAllowancesAmt"/>
									</xsl:call-template>
								</div>
								<div class="styLNRightNumBox" style="width:31mm; height:4mm;border-bottom-width:1px;"/>
							</div>
						</div>
					...
					<div class="styBB" style="width:187mm;height:auto">
						<div class="styIRS1120SVTImageBox" style="height:73mm;padding-top:6mm;">
						...
						<div style="width:181mm;float:right;">
							...
							<div class="styLNDesc" style="width:133mm;height:4mm;">
								<span style="float:left">Energy efficient commercial buildings deduction (attach Form 7205)<span style="width:2px;"/>
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="$Form1120SData/EnergyEffcntCmrclBldgDedAmt"/>
									</xsl:call-template>
									<!--Dotted Line-->
								</span>
								<span class="styDotLn" style="float:right;padding-right:1mm;">..........</span>
						...
						<!-- Line 22 -->
						<div style="width:181mm;float:right;">
							<div class="styLNLeftNumBox" style="height:4mm;padding-top:0mm;padding-bottom:0px">22</div>
							<div class="styLNDesc" style="width:133mm;height:4mm;padding-top:0mm;padding-bottom:0px">
								<span style="float:left">
									<b>Ordinary business income (loss). </b>Subtract line 21 from line 6
								</span>
								<span class="styDotLn" style="float:right;padding-right:1mm;">............</span>
							</div>
							<div class="styLNRightNumBoxNBB" style="padding-top:1mm;height:5mm;">22</div>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styIRS1120SVTImageBox" style="height:62mm;padding-top:11mm;">
						...
						<div class="styGenericDiv" style="width:181mm;border-top-width:1px">
							<div style="float:left;clear:none;">
								<div class="styLNLeftLtrBox" style="padding-left: 2.25mm;;border-top-width:1px">23a</div>
								<div class="styLNDesc" style="width:94mm;padding-left:1mm;;border-top-width:1px">
									...
									<span style="float:left">
										instructions)
										<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Line 23a - LIFO Tax Indicator</xsl:with-param>
											<xsl:with-param name="TargetNode" select="$Form1120SData/ExcessNetPassiveIncmLIFOTxAmt/@lIFOTaxCd"/>
											<xsl:with-param name="Style">padding-left:3mm;</xsl:with-param>
										</xsl:call-template>
										<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Line 23a - LIFO Tax Amount</xsl:with-param>
							...
							<div style="float:right;clear:none;">
								<div class="styLNRightNumBox" style="height:8mm;padding-top:4mm;;border-top-width:0px">23a</div>
						...
						<div style="width:181mm;float:right;">
							...
							<div class="styLNDesc" style="width:133mm;height:4.5mm;padding-bottom:0;padding-top:1mm;">
								<span style="float:left">
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 23c - Tax From Form 4255 Indicator</xsl:with-param>
										<xsl:with-param name="TargetNode" select="$Form1120SData/TotalTaxAmt/@taxFromForm4255Cd"/>
									</xsl:call-template>
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 23c - Tax From Form 4255 Amount</xsl:with-param>
										<xsl:with-param name="TargetNode" select="$Form1120SData/TotalTaxAmt/@taxFromForm4255Amt"/>
										<xsl:with-param name="Style">padding-left:3mm;</xsl:with-param>
									</xsl:call-template>
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 23c - LIFO Tax Indicator</xsl:with-param>
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 23c - LIFO Tax Amount</xsl:with-param>
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 23c - From Form 8697 Indicator</xsl:with-param>
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 23c - From Form 8697 Amount</xsl:with-param>
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 23c - From Form 8866 Indicator</xsl:with-param>
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 23c - From Form 8866 Amount</xsl:with-param>
									...
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 23c - Bipartisan Budget Act Imputed Underpayment Indicator</xsl:with-param>
										<xsl:with-param name="TargetNode" select="$Form1120SData/TotalTaxAmt/@bBAImputeUnderpaymentCd"/>
										<xsl:with-param name="Style">padding-left:18mm;</xsl:with-param>
									</xsl:call-template>
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 23c - Bipartisan Budget Act Imputed Underpayment Amount</xsl:with-param>
						...
						<!-- Line 24a -->
						<div class="styGenericDiv" style="width:181mm;height:8mm;">
							<div style="float:left;clear:none;">
								<div class="styLNLeftLtrBox" style="padding-left: 2.25mm;height:8mm;">24a</div>
								<div class="styLNDesc" style="width:94mm;padding-left:1mm;height:8mm;">
									Current year's estimated tax payments and preceding year's overpayment credited to the current year
									<!--Dotted Line -->
									<span class="styDotLn" style="float:right;padding-right:1mm;">..............</span>
								</div>
							</div>
							<div style="float:right;clear:none;height:8mm;">
						...
						<div class="styGenericDiv" style="width:181mm;">
							...
							<div style="float:right;clear:none;">
								<div class="styLNRightNumBox" style="height:4.5mm;">24b</div>
								<div class="styLNAmountBox" style="height:4.5mm;">
									<xsl:call-template name="PopulateAmount">
						...
						<div class="styGenericDiv" style="width:181mm;">
							...
							<div style="float:right;clear:none;">
								<div class="styLNRightNumBox" style="height:4.5mm;">24c</div>
								<div class="styLNAmountBox" style="height:4.5mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1120SData/TotalFuelTaxCreditAmt"/>
									</xsl:call-template>
						...
						<div class="styGenericDiv" style="width:181mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:94mm;padding-left:1mm;">
									<span style="float:left;">Elective payment election amount from Form 3800
										...
										<!-- Form to Form Link -->
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" select="$Form1120SData/ElectivePaymentAmt"/>
										</xsl:call-template>
									</span>
									<!--Dotted Line -->
									<span class="styDotLn" style="float:right;padding-right:1mm;">.....</span>
							...
							<div style="float:right;clear:none;">
								<div class="styLNRightNumBox" style="height:4.5mm;">24d</div>
								<div class="styLNAmountBox" style="height:4.5mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1120SData/ElectivePaymentAmt"/>
									</xsl:call-template>
						...
						<!-- line 24z Begin -->
						<div style="width:181mm;float:right;">
							<div class="styLNLeftLtrBox" style="height:4.5mm;padding-left:4.25mm;">z</div>
							<div class="styLNDesc" style="width:133mm;height:4mm;">
								<span style="float:left">Add lines 24a through 24d							
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 24z - Beneficiary Of Trust Indicator</xsl:with-param>
										<xsl:with-param name="TargetNode" select="$Form1120SData/TotalPaymentsAmt/@beneficiaryTrustCd"/>
									</xsl:call-template>
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 24z - Beneficiary Of Trust Amount</xsl:with-param>
							...
							<div class="styLNRightNumBox" style="height:4.5mm;">24z</div>
							<div class="styLNAmountBox" style="height:4.5mm;">
								<xsl:call-template name="PopulateAmount">
						...
						<div style="width:181mm;float:right;">
							...
							<div class="styLNDesc" style="width:133mm;height:4mm;">
								<span style="float:left">
									<span class="styBoldText">Amount owed.</span> If line 24z is smaller than the total of lines 23c and 25, enter amount owed 	</span>
								<span class="styDotLn" style="float:right;padding-right:1mm;">...</span>
							</div>							
						...
						<div style="width:181mm;float:right;">
							...
							<div class="styLNDesc" style="width:133mm;height:4.5mm">
								<span style="float:left">
									...
									If line 24z is larger than the total of lines 23c and 25, enter amount overpaid
								</span>
								<span class="styDotLn" style="float:right;padding-right:1mm;">...</span>
							</div>
						...
						<div style="width:181mm;float:right">
							...
							<span style=""/>
							<div class="styLNRightNumBoxNBB" style="height:4.9mm;">28</div>
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							...
							Form <span class="styBoldText" style="font-size:8pt;">1120&#8211;S</span> (2023)
						</div>
					</div>
					<!-- END Page Break and Footer-->
					<!--Begin Page 2 -->
					...
					<div class="styBB" style="width:187mm; padding-top:.5mm; float:none; clear:both;">
						<div style="float:left;">Form 1120&#8211;S (2023)<span style="width:148mm;"/>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:159mm;height:8mm;">If checked, the corporation may have to file
							<b> Form 8281</b>, Information Return for Publicly Offered Original Issue Discount Instruments.
						</div>
						<div class="styShadingCell" style="width:10mm;height:8mm;"/>
						<div class="styShadingCell" style="width:10mm;height:8mm;"/>
					</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:159mm;">
						The corporation&#8216;s aggregate average annual gross receipts (determined under section 448(c)) for the 3 tax years preceding&#160;&#160;the current tax year are more than $29 million and the corporation has business interest expense.
						</div>
					...
					<!-- BEGIN Schedule B Line 16 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style=";">16</div>
						<div class="styLNDesc" style="width:159mm;">
							  At any time during the tax year, did the corporation: (a) receive (as a reward, award, or payment for property or services); or (b) sell, exchange, gift, or otherwise dispose of a digital asset (or a financial interest in a digital asset)? See instructions
						</div>
						<div class="styShadingCell" style="width:10mm;height:3mm;border-bottom-width:1px;"/>
						<div class="styShadingCell" style="width:10mm;height:3mm;border-bottom-width:1px;"/>
						<div class="styIRS1120SLNYesNoBox" style="height:4mm;border-bottom-width:0px;;">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" select="$Form1120SScheduleB/VirtualCurAcquiredDurTYInd"/>
							</xsl:call-template>
						</div>
						<div class="styIRS1120SLNYesNoBox" style="height:4mm;border-bottom-width:0px;">
							<xsl:call-template name="PopulateNoBoxText">
						...
						<div class="styGenericDiv" style="width:177mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:124mm;">
									<span style="float:left;">Ordinary business income (loss) (page 1, line 22)
										<!-- Form to Form Link -->
										<xsl:call-template name="SetFormLinkInline">
						...
						<div class="styGenericDiv" style="width:177mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:123.7mm;">
									...
									<span style="width:35mm;padding-left:2mm;border-bottom:1px solid black">
										<xsl:call-template name="PopulateText">
					...
					<!-- BEGIN Schedule K, Credits Section -->
					<div class="styBB" style="width:187mm;float:none;clear:none;">
	...
	<!--<img src="{$ImagePath}/1120S_Bullet_Md.gif" alt="Right Pointing Arrow"/>-->&#160;
							...
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:123.7mm;height:10mm;padding-top:8mm;">
									<span style="float:left;">
										...
										Combine the total amounts on lines 1 through 10. From the result, subtract the 
					...
					<div style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:51mm;">
							<span style="float:left">
							Ordinary income from page 1, line 22
							</span>
						</div>
						<div class="styLNAmountBox" style="">
							<xsl:call-template name="PopulateAmount">
