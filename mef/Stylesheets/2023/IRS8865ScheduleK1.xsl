...
<!-- 10/16/2023 - Changes made for UWR 970319 - Jeremy Nichols -->
<!-- 11/07/2023 - Changes made for defect 1253241 - Jeremy Nichols -->
<!-- 11/07/2023 - Changes made for defect 1253205 - Jeremy Nichols -->
          ...
          OMB No. 1545-1668</span>
							...
							<table border="0" cellspacing="0" cellpadding="0" style="border-right:1px;">
								...
								<tr>
									...
									<td style="width: 52.75mm;font-size: 7pt;">		
										<div class="styTY" style="float: right; clear: none; padding-right: 2mm;">20<span class="styTYColor">23</span>
											<span style="font: normal normal 7pt Verdana; padding-left: 1mm;">
												<span style="width: 5mm;"/>
											</span>
										</div>
										<span style="width:52mm;text-align:right;padding-right:1mm;">For calendar year 2023, or tax<br/></span>
							...
							<table border="0" cellspacing="0" cellpadding="0" style="border-right:1px;">
								...
								<tr>
									<td class="IRS8865ScheduleK1_tdLeft" style="height: 12mm;border-left:0;">
										...
										<table cellpadding="0" cellspacing="0" style="margin-left: 5mm;" role="presentation">
											<tbody>
												<tr>
										...
										<span style="padding-top:0.5mm;">
											...
											<input type="checkbox" class="styckbox" name="checkbox" alt="decrease due to sale">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$FormData/DecrSalePrtnrPrtshpIntInd"/>
												</xsl:call-template>
											</input> 
											sale, or 
											<input type="checkbox" class="styckbox" name="checkbox" alt="decrease due to exchange">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$FormData/DecrExchPrtnrPrtshpIntInd"/>
												</xsl:call-template>
											</input> 
                      ...
                      <span style="width: 12px;"/>.
						...
						<td style="width: 100mm;" valign="top">
							<table border="0" cellpadding="0" cellspacing="0" style="width:100mm;border-top: 1px solid black; border-bottom: 0px; border-left:1px solid black; border-right:1px solid black;">
								...
								<tr>
									<td valign="top">
										<table width="50mm" border="0" cellpadding="0" cellspacing="0" style="border-right: 0px solid black;" role="presentation">
									...
									<td style="width:100mm;border-left:1px solid black;" valign="top">
										<table width="50mm" border="0" cellpadding="0" cellspacing="0" style="border-left: 0;" role="presentation">
											<!-- Line 15 -->
											<tr>
												<td style="width:5mm;font-weight:bold;text-align:center;border-right:1px solid black;border-top:1px solid black;">
													15
					...
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm; font-family: Verdana; font-size: 6pt; font-weight: bold; border-top: 1px solid black;">
							...
							<span style="width: 1mm;"/>
							<span style="width: 39mm;">Schedule K-1 (Form 8865) 2023</span>
						</td>
					</tr>
				</table>
