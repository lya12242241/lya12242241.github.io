			...
			<body class="styBodyClass">
				<form id="Form1040Schedule2">
                    ...
                    <div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;font-weight:bold;font-size:6.5pt;">Schedule 2 (Form 1040) 2023</span>
					</div>
                    <!-- page break -->
                    <div class="styStdDiv">
                    ...
                    <div class="styStdDivNoScroll">
                        ...
                        <div class="sty1040Sch2AmountBox" style="padding-right:0.5mm;background-color:lightgrey">
                        </div>
                    </div>
                    <!-- Line 20 -->
                    <div class="styStdDivNoScroll">
