          ...
          <table class="styTable" cellspacing="0" name="TYTable" id="TYTable" style="border-color:black;">
            <thead class="styTableThead">
              <tr style="height:6mm;border-color:black;">
                ...
                scope="col">
					Type of property—State whether rehabilitation, energy, qualifying advanced coal project, qualifying
				    gasification project, qualifying advanced energy project, or advanced manufacturing investment property.
				    (See the Instructions for Form 3468 for the year the investment credit property was placed in service for 
				    definitions.) If rehabilitation property, also show type of building. If energy property, show type.
                </th>
              </tr>
            </thead>
            <tfoot/>
    ...
    and ($Print = $Separated))">
      ...
      <div class="styBB" style="width:187mm;">
        ...
        <div style="width:187mm;">
          ...
          <div class="styLNAmountBox" style="width:27.5mm;vertical-align:bottom;background-color:lightgrey">
            <!--<xsl:call-template name="PopulateAmount">
              <xsl:with-param name="TargetNode" select="$Form4255Data/TxForRcptrQlfyThrputicDiscvAmt"/>
            </xsl:call-template>-->
          </div>
        ...
        <div style="width:187mm;">
          ...
          <div class="styLNDesc" style="height:4mm;width:146.3mm;vertical-align:bottom;">
            Total increase in tax.  Add lines 17 and 18. Enter here and on the appropriate line of your tax return
            <!--Dotted Line-->
                       <span class="styDotLn" style="float:none;">.....</span>
          </div>
          <div class="styLNRightNumBox" style="height:4mm;padding-top:1mm;border-bottom:0px">
            20
          </div>
          <div class="styLNAmountBox" style="height:4mm;width:27.5mm;padding-top:1mm;border-bottom:0px">
            <xsl:call-template name="PopulateAmount">
      ...
      <div style="width:187mm; font-size:7pt;  border-top:1 solid black">    
        ...
        Form <b style="font-size:9pt">4255</b> (Rev. 12-2023)
        </div>      
      </div> 
