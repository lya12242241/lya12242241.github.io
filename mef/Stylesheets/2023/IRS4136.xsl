				...
				<form name="IRS4136">
					...
					<div class="styBB" style="width:187mm;height:21mm;border-bottom-width:2px;">
						...
						<div class="styTYBox" style="width:29mm;height: 21mm;border-left-width:2px;">
							...
							<div class="styTYBox" style="border:none;padding-left: 2mm; text-align: left;">Attachment<br/>Sequence No. <b>79</b>
							</div>
						</div>
					</div>
					<!--   END FORM HEADER -->
                ...
                Other nontaxable use (see <b>Caution </b>above line 1)   
					...
					<div style="width:187mm;">
						...
						<div style="float:right">Cat. No. 12625R
							<span style="width:70px"/>Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2023)
						</div>
					</div>
					<!-- ============================================================================= -->
					<!--  PAGE 2 HEADER -->
					...
					<p style="page-break-before: always">
						<div class="styBB" style="width:187mm;border-bottom:2px solid black;">
							<div style="float: left; clear: none">Form 4136 (2023)</div>
...
-->
					...
					<div style="width:187mm;">
						...
						<div style="float:right">
							<span style="width:70px"/>Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2023)</div>
					</div>
					<!-- ============================================================================= -->
					<!--  PAGE 3 HEADER -->
					<!-- ============================================================================= -->
					...
					<div class="styIRS4136NumLine" style="padding-left:1mm;">
						10<span style="width:5mm"/>Biodiesel, Renewable Diesel, or Sustainable Aviation Fuel Mixture <br/>
						<span style="width:9mm"/>Credit
						<span style="float:right;width:70mm;">Registration No.<img src="{$ImagePath}/4136_Bullet.gif" alt="Right pointing arrowhead"/>
						<xsl:call-template name="SetFormLinkInline">
					...
					<b>Biodiesel or renewable diesel mixtures.   </b>  Claimant produced a mixture by mixing biodiesel with diesel fuel or renewable diesel with liquid fuel
...
<b>Sustainable aviation fuel (SAF) mixtures.</b> Claimant produced a qualified mixture by mixing SAF with kerosene. The qualified mixture was
...
emissions reduction percentage of at least 50 percent. <b>For all claims.</b> Claimant has attached the appropriate certificates and, if applicable,
...
instructions for additional information and requirements.
					...
					<div style="width:187mm;float:left;clear:left;" id="UVctn">
						<table class="styIRS4136Table" cellspacing="0">
							<xsl:call-template name="NoColATableHeaderNoBraces">
								<xsl:with-param name="ColCHeader" select="'(c) Number of gallons sold or used'"/>
							</xsl:call-template>
							<tfoot/>
							<tbody>
								<!-- ============================================================================= -->
								...
								<!-- ============================================================================= -->
								<tr>
									<td class="styIRS4136LetterCell" style="vertical-align:bottom;">a</td>
								...
								<tr>
									...
									<td class="styIRS4136TableCellLine">Sustainable aviation fuel mixture (see instructions)</td>
									<td class="styIRS4136TableCellB"> $ 
										<xsl:call-template name="PopulateText">
...
<!--					<div class="styBB" style="width:177mm;margin-left:10mm;padding-bottom:1mm;">
        ...
        <span class="styDotLn">.................</span>
					...
					<div class="pageEnd" style="width:187mm;padding-top:.5mm;">
						<div style="float:right">
							<span style="width:80px"/>Form <span class="styBoldText">4136</span> (2023)</div>
					</div>
					<!-- ============================================================================= -->
					<!--  LEFTOVER DATA -->
					<!-- ============================================================================= -->
	...
	<xsl:template name="NoColATableHeaderNoBraces">
		...
		<thead class="styIRS4136TableThead">
			<tr>
				<th class="styIRS4136LetterCell" scope="col"/>
				<th class="styIRS4136TableCellLine" style="width:98mm;" scope="col"/>
				<th class="styIRS4136TableCellB" style="text-align:center;padding-right:0;vertical-align:top;" scope="col">
					<b>(b) Rate</b>
				</th>
				<th class="styIRS4136TableCellC" style="vertical-align:top;" scope="col">
