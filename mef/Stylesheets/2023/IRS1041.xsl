...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<!--<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>-->
				...
				<form id="Form1041">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div style="width:187mm;height:14mm;">
							...
							<div class="styGenericDiv" style="width:21mm;height:14mm;border-right:2px solid black;border-left:2px solid black;padding-top:2mm;padding-left:8px;padding-right:8px;">
								<span class="styTaxYear">20<span class="styTYColor">23</span></span>
							</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:39.8mm;float:left;">
							...
							<div class="styLNDesc" style="height:5mm;width:39.8mm;padding-top:.5mm;padding-bottom:0mm;">
								<label>
									...
									<input class="styCkbox" type="checkbox" alt="Decedent Estate" style="width:4mm;">
							...
							<div class="styLNDesc" style="height:5mm;width:39.8mm;padding-top:.5mm;padding-bottom:0mm;">
								<label>
									...
									<input class="styCkbox" type="checkbox" alt="Simple trust" style="width:4mm;">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/SimpleTrustInd"/>
											<xsl:with-param name="BackupName">$FormDataSimpleTrustInd</xsl:with-param>
										</xsl:call-template>
							...
							<div class="styLNDesc" style="height:5mm;width:39.8mm;padding-top:.5mm;padding-bottom:0mm;">
								<label>
									...
									<input class="styCkbox" type="checkbox" alt="Complex trust" style="width:4mm;">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/ComplexTrustInd"/>
											<xsl:with-param name="BackupName">$FormDataComplexTrustInd</xsl:with-param>
										</xsl:call-template>
							...
							<div class="styLNDesc" style="height:5mm;width:39.8mm;padding-top:.5mm;padding-bottom:0mm;">
								<label>
									...
									<input class="styCkbox" type="checkbox" alt="Qualified disability trust" style="width:4mm">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/QualifiedDisabilityTrustInd"/>
											<xsl:with-param name="BackupName">$FormDataQualifiedDisabilityTrustInd</xsl:with-param>
										</xsl:call-template>
							...
							<div class="styLNDesc" style="height:5mm;width:39.8mm;padding-top:.5mm;padding-bottom:0mm;">
								<label>
									...
									<input class="styCkbox" type="checkbox" alt="ESBT S Portion Only" style="width:4mm">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/ESBTSPortionOnlyInd"/>
											<xsl:with-param name="BackupName">$FormDataESBTSPortionOnlyInd</xsl:with-param>
										</xsl:call-template>
							...
							<div class="styLNDesc" style="height:5mm;width:39.8mm;padding-top:.5mm;padding-bottom:0mm;">
								<label>
									...
									<input class="styCkbox" type="checkbox" alt="Grantor type trust" style="width:4mm;">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/GrantorTypeTrustInd"/>
											<xsl:with-param name="BackupName">$FormDataGrantorTypeTrustInd</xsl:with-param>
										</xsl:call-template>
							...
							<div class="styLNDesc" style="height:5mm;width:39.8mm;padding-top:.5mm;padding-bottom:0mm;">
								<label>
									...
									<input class="styCkbox" type="checkbox" alt="Bankruptcy estate Chapter 7" style="width:4mm">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/BankruptcyEstateChap7Ind"/>
											<xsl:with-param name="BackupName">$FormDataBankruptcyEstateChap7Ind</xsl:with-param>
										</xsl:call-template>
							...
							<div class="styLNDesc" style="height:5mm;width:39.8mm;padding-top:.5mm;padding-bottom:0mm;">
								<label>
									...
									<input class="styCkbox" type="checkbox" alt="Bankruptcy estate Chapter 11" style="width:4mm;">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/BankruptcyEstateChap11Ind"/>
											<xsl:with-param name="BackupName">$FormDataBankruptcyEstateChap11Ind</xsl:with-param>
										</xsl:call-template>
							...
							<div class="styLNDesc" style="height:5mm;width:39.8mm;padding-top:.5mm;">
								<label>
									...
									<input class="styCkbox" type="checkbox" alt="Pooled income fund" style="width:4mm;">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/PooledIncomeFundInd"/>
											<xsl:with-param name="BackupName">$FormDataPooledIncomeFundInd</xsl:with-param>
										</xsl:call-template>
						...
						<div class="styGenericDiv" style="width:146.9mm;height:59.6mm;float:left;border-left:1px solid black;">
							<div class="styBB" style="width:146.9mm;height:5mm;padding-top:1mm;padding-left:1mm;">For calendar year 2023 or fiscal year beginning 
					...
					<div style="width:187mm;border-bottom:1px solid black;">			
						...
						<div style="width:181.8mm;float:left;border-left:1px solid black;">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">2023 net 965 tax liability paid from Form 965-A, Part II, column (k), line 5</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
											<xsl:with-param name="DotQty" select="8"/>
										</xsl:call-template>			  
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">Amount on line 29 to be: <b> a Credited to 2024</b><span style="width:2px;" /><img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/></span>				
		...
		<div class="pageEnd" style="width:187mm;">
			...
			<span style="float:right;clear:none;">
               Form <span class="styBoldText" style="font-size:10pt;">1041</span> (2023)
            </span>
		</div>
		<!-- end page 1 footer -->
		...
		<div class="styTBB" style="width:187mm;padding-top:.5mm;">
			<span class="" style="float:left;clear:none;">Form 1041 (2023)</span>
	...
	<!--Line 4-->
		   ...
		   <!--Line 6a-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:139.8mm;height:5mm;">
				<span style="float:left;">Recapture tax from Form 4255
					<xsl:call-template name="SetFormLinkInline">
						<xsl:with-param name="TargetNode" select="$FormData/TotalIncreaseInTaxAmt"/>
					</xsl:call-template>	</span>
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="20"/>
		  ...
		  <!--Line 6b-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">6b</div>
			  <div class="styLNDesc" style="width:139.8mm;height:5mm;">
		  ...
		  <!--Line 6c-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">6c</div>
			  <div class="styLNDesc" style="width:139.8mm;height:5mm;">
		...
		<div class="styBB" style="width:187mm;border-top-width:1px;">			
		  ...
		  <!--Line 17-->
		   ...
		   <!--Line 18b-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBox" style="height:4mm;">18b</div>
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;">Other credits or payments (see instruction) </span>
				<span class="styBoldText" style="float:right;padding-right:10px;">	
			<xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="17"/>
					</xsl:call-template>	
		  ...
		  <!--Line 17-->
			<!--<div style="width:187mm;font-size:7pt;float:left;">
				<div class="styLNLeftNumBox" style="height:4mm;">17</div>
				<div class="styLNDesc" style="width:139.8mm;height:4mm;">
					<span style="float:left;">Credit for qualified sick and family leave wages for leave taken before April 1, 2022.
						<xsl:call-template name="SetFormLinkInline">
			...
			<!--<div style="width:187mm;font-size:7pt;float:left;">
				...
				<div class="styLNDesc" style="width:139.8mm;height:7mm;">
					Credit for qualified sick and family leave wages for leave taken after March 31, 2022 and before 
					<span style="float:left;">October 1, 2022. </span>
					<span class="styBoldText" style="float:right;padding-right:10px;">
						<xsl:call-template name="DotLoop">						
							<xsl:with-param name="DotQty" select="24"/>
						</xsl:call-template>
			...
			<div style="width:187mm;font-size:7pt;float:left;">
				<div class="styLNLeftNumBox" style="height:4mm;">19</div>
				<div class="styLNDesc" style="width:139.8mm;height:4mm;">
					<span style="float:left;"><b>Total payments.</b> Add lines 12 through 18b. Enter here and on page 1, line 26	</span>
					<span class="styBoldText" style="float:right;padding-right:10px;">
						<xsl:call-template name="DotLoop">						
							<xsl:with-param name="DotQty" select="8"/>
						</xsl:call-template>			  
		...
		<!--Line 1-->
		  ...
		  <!--Line 3 (1)-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">3</div>
			  <div class="styLNDesc" style="width:159mm;height:4mm;">
				<span style="float:left;width:158.9mm;height:auto;">At any time during calendar year 2023, did the estate or trust have an interest in or a signature or other authority</span>
		 ...
		 <!--Line 4-->
		  ...
		  <!--Line 13 (2)-->
			...
			<div class="styPartDesc" style="width:10mm;text-align:center;height:4.2mm;padding:0mm;border-left:1px solid black;border-bottom:1px solid black;">
				...
				<input type="Checkbox" alt="VirtualCurAcquiredDurTYIndYes" class="styCkbox">
					<xsl:call-template name="PopulateYesCheckbox">
			...
			<div class="styPartDesc" style="width:10mm;text-align:center;height:4.2mm;padding:0mm;border-left:1px solid black;border-bottom:1px solid black;">
				...
				<!-- Checkbox -->
				<input type="Checkbox" alt="VirtualCurAcquiredDurTYIndNo" class="styCkbox">
					<xsl:call-template name="PopulateNoCheckbox">
						<xsl:with-param name="TargetNode" select="$FormData/VirtualCurAcquiredDurTYInd"/>
						<xsl:with-param name="BackupName">IRS1041VirtualCurAcquiredDurTYInd</xsl:with-param>
					</xsl:call-template>
