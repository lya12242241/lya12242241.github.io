				...
				<form name="IRS8379" style="font-family:arial;">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:2px;">
						<div class="styFNBox" style="width:31mm;height:19mm;border-right-width:2px;padding-top:.5mm;">
							...
							<span class="styAgency">(Rev. November 2023)</span>
							<br/>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8379LineItem" style="height:6mm;">
							...
							<div class="styIRS8379LNDesc" style="width:73mm;">
						...
						<div class="styIRS8379LineItem" style="height:18mm;">
							...
							<div class="styIRS8379LNDesc" style="width:181mm;">
								...
								<label>
									...
									<span style="width:8mm;"/>Skip lines 6 through 9. <b>Go to Part II</b> and complete the rest of this form.<br/>
								</label>
								<!-- ++++++++++++++ No Checkbox +++++++++++++ -->
								<span>
									<xsl:call-template name="PopulateSpan">
					...
					<div class="styBB" style="width:187mm;border-top:0px solid black;">
						...
						<div class="styPartDesc">Information About the Joint Return for Which This Form Is Filed</div>
					</div>
					<!-- Body -->
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styIRS8379LineItem" style="height:20mm;">
							...
							<div class="styIRS8379LNDesc" style="width:181mm;padding-top:0px;">
								...
								<div class="styIRS8379CleanDiv" style="padding-top:0px;width:100%; height:4mm;">
<div class="styIRS8379CleanDiv" style="padding-top:0px;width:100%; height:50%;">
										<div class="styIRS8379CleanDiv" style="padding-top:0px;width:100%; height:100%;font-size:8.5pt;">
											If “Yes,” enter the address. If a foreign address, see instructions.
										</div>
										
									</div>
							</div>
								<div class="styIRS8379CleanDiv" style="padding-top:0px;width:100%; height:6mm;border-bottom-width:1px;">
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt;border-top:2px solid black; padding-top:0.5mm;text-align:right;">
						<div style="float:left;">
							...
							<span style="width:22mm;"/>                        
									...
									Form <span class="styBoldText" style="font-size:8pt;">8379</span> (Rev. 11-2023)
								</div>
						</div>
					</div>
					...
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">
							Form 8379 (Rev. 11-2023)<span style="width:148mm;"/>
						</div>
					...
					<div class="styBB" style="width:187mm;border-top:0px solid black;">
						...
						<div class="styPartDesc">Allocation Between Spouses of Items on the Joint Return. <span class="styNormalText"> See the separate Form 8379 instructions for Part III.</span>
						</div>
					</div>
					<!-- Body -->
						...
						<div class="styIRS8379LineItem" style="border-bottom-width:1px;border-color:black;height:auto;">
							<div class="styIRS8379CleanDiv" style="width:100%;height:10mm;padding-top:0px;">
								<div class="styIRS8379CleanDiv" style="width:55%;height:auto;">
									<span class="styBoldText" style="width:100%;text-align:center;font-size:8.5pt;">
										Allocated Items<br/>
										
										<span class="styNormalText">
											(Column <b>(a)</b> must equal columns <b>(b)</b> + <b>(c)</b>)
										</span>
									</span>
								</div>
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						<div style="float:right;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">8379</span> (Rev. 11-2023)
						</div>
					</div>
