				...
				<form id="Form8915F">
					...
					<div class="styStdDiv">
						<div class="styFNBox" style="width:31mm;height:21mm;border-right-width:2px;">
							...
							<div class="" style="padding-top:.5mm;font-size:7pt;">(Rev. January 2024)</div>
							<br />
					...
					<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
						...
						<span style="float:right;">Form <strong>8915-F</strong> (Rev. 1-2024)</span>
					</div>
					<!-- Page 2 -->
					<div class="styStdDiv">
					...
					<div class="styStdDiv">
						...
						<div class="sty8915FDescBox" style="height:auto;">
							See line 1a below to determine whether you need to complete lines 1a through 1e. You must use Worksheet 1B in the instructions <span style ="font-weight:bold;">if</span> you are directed to do so in line 1a. However, you can always choose to use Worksheet 1B.
						</div>
						<div class="styLNRightNumBoxNBB" style="border-top:1px solid black;height:10mm;">&nbsp;</div>
						<div class="styLNAmountBoxNBB" style="width:30mm;height:10mm;background-color:lightgrey;">&nbsp;</div>
						<div class="styLNAmountBoxNBB" style="width:30mm;height:10mm;">&nbsp;</div>
					</div>
					<!-- Part 1 Line 1a -->
					<div class="styStdDiv">
...
on line 1a.
								...
								<li>Otherwise, for lines 1a through 5, you must use Worksheet 1B in the instructions
									<span class="sty8915FDotLn">.....................</span>
								</li>
							</ul>
						</div>
						<div class="styLNRightNumBox" style="height:80mm;padding-top:76mm;">1a</div>
						<div class="styLNAmountBox" style="width:30mm;height:80mm;background-color:lightgrey;">&nbsp;</div>
						<div class="styLNAmountBox" style="width:30mm;height:80mm;padding-top:76mm;">
					...
					<div class="styStdIBDiv" style="margin-top:2mm;margin-bottom:2mm;padding:0.5mm 0px;">
						...
						<span style="width:120.5mm;border-bottom:1px solid black;text-align:center;">
							<xsl:for-each select="$FormData/MainHomeQlfyDistributionsGrp/QualifiedDistributionDt">
								<xsl:call-template name="PopulateMonthDayYear">
									<xsl:with-param name="TargetNode" select="$FormData/MainHomeQlfyDistributionsGrp/QualifiedDistributionDt"/>
								</xsl:call-template>
								<xsl:if test="position() != last()">,<span style="width:4px;"/></xsl:if>
							</xsl:for-each>
						</span>
